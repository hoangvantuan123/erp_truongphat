...
import HrEduRstEndActions from '../../components/actions/hrEdu/hrEduRstEndActions'
import HrEduRstEndQuery from '../../components/query/hrEdu/hrEduRstEndQuery'
import { searchEduRstEnd } from '../../../features/mgn-hr/hr-edu-rst/searchEduRstEnd'
import TableEduRstEnd from '../../components/table/edu-rst/tableEduRstEnd'
import { auHrEduRstEnd } from '../../../features/mgn-hr/hr-edu-rst/AuHrEduRstEnd'
import { filterValidRows } from '../../../utils/filterUorA'
export default function HrEduRstEnd({
  permissions,
  isMobile,
  canCreate,
  canEdit,
  ...
  const onClickSearch = useCallback(async () => {
    ...
    try {
      ...
      const response = await searchEduRstEnd(data)
