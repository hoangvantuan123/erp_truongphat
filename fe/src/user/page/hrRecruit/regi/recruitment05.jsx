...
import Recruit05Table from '../../../components/table/hrRecruit/regi/recruit05Table'
import Recruit05Action from '../../../components/actions/hrRecruit/regi/recruit05Action'
import Recruit05Query from '../../../components/query/hrRecruit/regi/recruit05Query'
import { HrLangsRecruitA } from '../../../../features/hr/HrLangRecruit/HrLangsRecruitA'
import { HrLangsRecruitU } from '../../../../features/hr/HrLangRecruit/HrLangsRecruitU'
import { HrLangsRecruitD } from '../../../../features/hr/HrLangRecruit/HrLangsRecruitD'
import { HrLangsRecruitQ } from '../../../../features/hr/HrLangRecruit/HrLangsRecruitQ'
import { CodeHelpItemH } from '../../../../features/codeHelp/codeHelpItemH'
export default function HrRecruitment05({ permissions, isMobile, canCreate, canEdit, canDelete, controllers,
    cancelAllRequests }) {
    ...
    const fetchCodeHelpData = useCallback(async () => {
        ...
        try {
            const [res1, res2, res3, res4, res5, res6, res7, res8, res9, res10, res11] = await Promise.allSettled([
                ...
                CodeHelpItemH({ KeyItem1: '30009', signal }),
                CodeHelpItemH({ KeyItem1: '30010', signal }),
                CodeHelpItemH({ KeyItem1: '30011', signal }),
            ]);
    ...
    const handleSearchData = useCallback(async () => {
        ...
        fetchGenericData({
            controllerKey: 'HrLangsRecruitQ',
            postFunction: HrLangsRecruitQ,
            searchParams,
    ...
    const handleDeleteDataSheet = useCallback(
        (e) => {
            ...
            if (rowsWithStatusD.length > 0) {
                ...
                HrLangsRecruitD(rowsWithStatusD)
                    .then((response) => {
                        if (response.success) {
    ...
    const handleSaveData = useCallback(async () => {
        ...
        try {
            const apiCalls = [];
            if (resulA.length > 0) apiCalls.push(HrLangsRecruitA(resulA));
            if (resulU.length > 0) apiCalls.push(HrLangsRecruitU(resulU));
