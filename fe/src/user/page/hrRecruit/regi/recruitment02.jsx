...
import Recruit02Table from '../../../components/table/hrRecruit/regi/recruit02Table'
import Recruit02Action from '../../../components/actions/hrRecruit/regi/recruit02Action'
import Recruit02Query from '../../../components/query/hrRecruit/regi/recruit02Query'
import { EmpSPInterviewH } from '../../../../features/codeHelp/EmpSPInterviewH'
import { HrAcademyRecruitA } from '../../../../features/hr/HrAcademyRecruit/HrAcademyRecruitA'
import { HrAcademyRecruitU } from '../../../../features/hr/HrAcademyRecruit/HrAcademyRecruitU'
import { HrAcademyRecruitD } from '../../../../features/hr/HrAcademyRecruit/HrAcademyRecruitD'
import { HrAcademyRecruitQ } from '../../../../features/hr/HrAcademyRecruit/HrAcademyRecruitQ'
export default function HrRecruitment02({ permissions, isMobile, canCreate, canEdit, canDelete, controllers,
    cancelAllRequests }) {
    ...
    const handleSearchData = useCallback(async () => {
        ...
        fetchGenericData({
            controllerKey: 'HrAcademyRecruitQ',
            postFunction: HrAcademyRecruitQ,
            searchParams,
    ...
    const handleDeleteDataSheet = useCallback(
        (e) => {
            ...
            if (rowsWithStatusD.length > 0) {
                ...
                HrAcademyRecruitD(rowsWithStatusD)
                    .then((response) => {
                        if (response.success) {
    ...
    const handleSaveData = useCallback(async () => {
        ...
        try {
            const apiCalls = [];
            if (resulA.length > 0) apiCalls.push(HrAcademyRecruitA(resulA));
            if (resulU.length > 0) apiCalls.push(HrAcademyRecruitU(resulU));
    ...
    return (
        <>
            <Helmet>
                <title>{t('Đăng ký thông tin trường học')}</title>
            </Helmet>
