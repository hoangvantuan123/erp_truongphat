...
import StockReal6Action from '../../components/actions/scan/stockReal6Action'
import StockReal6Table from '../../components/table/scan/StockReal6Table'
import StockReal6Query from '../../components/query/scan/StockReal6Query'
...
export default function StockReal6({ permissions, isMobile, canCreate, canEdit, canDelete, controllers,
    cancelAllRequests }) {
    ...
    const defaultCols = useMemo(() => [
        { title: '', id: 'Status', kind: 'Text', readonly: true, width: 80, hasMenu: true, visible: true, themeOverride: { textDark: "#225588", baseFontStyle: "600 13px" }, trailingRowOptions: { disabled: false }, icon: GridColumnIcon.HeaderLookup },
        { title: t('Đã nhập kết quả'), id: 'IsStkReal', kind: 'Text', readonly: false, width: 140, hasMenu: true, visible: true, trailingRowOptions: { disabled: true }, },
        { title: t('2'), id: 'BizUnitName', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('21656'), id: 'StkMngNo', kind: 'Text', readonly: false, width: 160, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('Kho kiểm kê'), id: 'WHName', kind: 'Text', readonly: false, width: 130, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('21652'), id: 'StkDate', kind: 'Text', readonly: false, width: 180, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('360'), id: 'EmpName', kind: 'Text', readonly: false, width: 120, hasMenu: true, visible: true, trailingRowOptions: { disabled: true }, },
    ], [t]);
    ...
    console.log('dataSearch3', dataSearch2)
    ...
    const handleSearchData = useCallback(async () => {
        ...
        fetchGenericData({
            controllerKey: 'StockRealOpenQ',
            postFunction: StockRealOpenQ,
            searchParams,
    ...
    const nextPage = useCallback(() => {
        ...
        const postData = [{
            StkMngSeq: selected[0].StkMngSeq,
            IsStkReal: selected[0].IsStkReal,
        }];
        ...
        const route = `/app/wms/u/warehouse/stock-real/stock-real-1-6/${encryptedToken}`;
                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="col-start-1 col-end-5 row-start-1 w-full rounded-lg">
                        <div className="flex items-center justify-between bg-white p-2">
                            <StockReal6Action handleSearchData={handleSearchData} nextPage={nextPage} />
                        </div>


                        <div className='flex items-center px-2 p-1  text-blue-800 justify-between border-t text-[13px]  border-b   font-medium'>
