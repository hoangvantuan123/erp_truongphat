...
import PurDelvInItemListQuery from '../../components/query/purchase/purDelvInItemListQuery'
import PurDelvInItemListActions from '../../components/actions/purchase/purDelvInItemListActions'
import TablePurDelvInItemList from '../../components/table/purchase/tablePurDelvInItemList'
import { GetSheetQuery } from '../../../features/purchase/purDelvInItemList/getSheetQuery'
...
export default function PurDelvInItemList({
  permissions,
  isMobile,
  canEdit,
  setCollapsed,
  ...
  const [cols, setCols] = useState(() =>
    loadFromLocalStorageSheet(
      'S_ERP_COLS_PAGE_DELV_IN_ITEM_LIST',
      ...
      const data = [
        {
          ...
          BizUnit: bizUnit,
          BizUnitName: '',
          DelvInDateFr: fromDate ? formatDate(fromDate) : '',
          DelvInDateTo: toDate ? formatDate(toDate) : '',
          WHSeq: whSeq,
          DelvMngNo: delvMngNo,
          POMngNo: pOMngNo,
          DelvInNo: delvInNo,
  ...
  const nextPage = useCallback(() => {
    if (keyPath && sMImpType === 8008001) {
      window.open(`/pur/u/purchase/pu-delv-in-link/${keyPath}`, '_blank')
    }
  }, [keyPath])
  ...
  return (
    <>
      <Helmet>
        <title>ITM - {t('Truy vấn chi tiết nhập kho mua hàng')}</title>
      </Helmet>
          ...
          <div className="col-start-1 col-end-5 row-start-1 w-full rounded-lg ">
            <div className="flex items-center justify-between mb-2">
              <Title level={4} className="mt-2 uppercase opacity-85 ">
                {t('Truy vấn chi tiết nhập kho mua hàng')}
              </Title>
              <PurDelvInItemListActions
                nextPage={nextPage}
                debouncedFetchSPUDelvInItemListQueryWEB={fetchSheetQuery}
              />
            </div>
            <details
