...
import ImpOrderListQuery from '../../components/query/purchase/impOrderListQuery'
import ImpOrderListActions from '../../components/actions/purchase/impOrderListActions'
import TableImpOrderList from '../../components/table/purchase/tableImpOrderList'
import { GetSheetQuery } from '../../../features/purchase/impOrderList/getSheetQuery'
import { PostPOListConfirm } from '../../../features/purchase/impOrderList/postPOListConfirm'
import { PostPOListStop } from '../../../features/purchase/impOrderList/postPOListStop'
...
export default function ImpOrderList({
  permissions,
  isMobile,
  canEdit,
  controllers,
  ...
  useEffect(() => {
    const savedState = localStorage.getItem('detailsStateImpOrderList')
  ...
  const handleToggle = (event) => {
    ...
    localStorage.setItem('detailsStateImpOrderList', isOpen ? 'open' : 'closed')
  }

  const fetchSIMPORDERListQueryWEB = async () => {
  ...
  const nextPage = useCallback(() => {
    if (keyPath) {
      window.open(`/pur/u/import/imp-order-link/${keyPath}`, '_blank')
    }
  }, [keyPath])
  //Sheet
          ...
          <div className="col-start-1 col-end-5 row-start-1 w-full rounded-lg ">
            <div className="flex items-center justify-between mb-2">
              <Title level={4} className="mt-2 uppercase opacity-85 ">
                {t('Truy vấn đặt mua hàng nhập khẩu')}
              </Title>
              <ImpOrderListActions
                nextPage={nextPage}
                debouncedFetchSIMPORDERListQueryWEB={fetchSIMPORDERListQueryWEB}
              />
            </div>
            <details
