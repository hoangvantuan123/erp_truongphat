...
import PurOrderApprovalReqItemListQuery from '../../components/query/purchase/purOrderApprovalReqItemListQuery'
import PurOrderApprovalReqItemListActions from '../../components/actions/purchase/purOrderApprovalReqItemListActions'
import TablePurOrdApprovalReqItemList from '../../components/table/purchase/tablePurOrdApprovalReqItemList'
import { GetSheetQuery } from '../../../features/purchase/purOrdApprovalReqItemList/getSheetQuery'
...
export default function PurOrdApprovalReqItemList({
  permissions,
  isMobile,
  canEdit,
  setCollapsed,
  ...
  const [cols, setCols] = useState(() =>
    loadFromLocalStorageSheet(
      'S_ERP_COLS_PAGE_ORD_APPROVAL_REQ_ITEM_LIST',
  ...
  const nextPage = useCallback(() => {
    if (keyPath && sMImpType === 8008001) {
      window.open(`/pur/u/purchase/ord-po/${keyPath}`, '_blank')
    } else if (keyPath && sMImpType === 8008004) {
      window.open(`/pur/u/import/imp-order/${keyPath}`, '_blank')
    }
  }, [keyPath])
      ...
      >
        <div className="flex flex-col gap-4 md:grid md:grid-cols-4 md:grid-rows-[auto_1fr] md:gap-4 h-full">
          <div className="col-start-1 col-end-5 row-start-1 w-full rounded-lg ">
            <div className="flex items-center justify-between mb-2">
              <Title level={4} className="mt-2 uppercase opacity-85 ">
                {t('Truy vấn chi tiết xin phép mua hàng')}
              </Title>
              <PurOrderApprovalReqItemListActions
                nextPage={nextPage}
                debouncedFetchSPUORDApprovalReqItemListQueryWEB={
                  fetchSheetQuery
                }
              />
            </div>
            ...
            >
              ...
              <PurOrderApprovalReqItemListQuery
                fromDate={fromDate}
          ...
          <div className="col-start-1 col-end-5 row-start-2 w-full h-full rounded-lg">
            {
              <TablePurOrdApprovalReqItemList
