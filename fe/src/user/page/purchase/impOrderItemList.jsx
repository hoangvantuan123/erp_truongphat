...
import ImpOrderItemListQuery from '../../components/query/purchase/impOrderItemListQuery'
import ImpOrderItemListActions from '../../components/actions/purchase/impOrderItemListActions'
import TableImpOrderItemList from '../../components/table/purchase/tableImpOrderItemList'
import { GetSheetQuery } from '../../../features/purchase/impOrderItemList/getSheetQuery'
...
export default function ImpOrderItemList({
  permissions,
  isMobile,
  canEdit,
  setCollapsed,
  ...
  return (
    <>
      <Helmet>
        <title>HPM - {t('Truy vấn chi tiết nhập đặt hàng nhập khẩu')}</title>
      </Helmet>
          ...
          <div className="col-start-1 col-end-5 row-start-1 w-full rounded-lg ">
            <div className="flex items-center justify-between mb-2">
              <Title level={4} className="mt-2 uppercase opacity-85 ">
                {t('Truy vấn chi tiết nhập đặt hàng nhập khẩu')}
              </Title>
              <ImpOrderItemListActions
                nextPage={nextPage}
                debouncedFetchSIMPORDERItemListQueryWEB={fetchSheetQuery}
              />
            </div>
            <details
