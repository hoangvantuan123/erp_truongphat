...
import PurOrderPOActions from '../../components/actions/purchase/purOrderPOActions'
import PurOrderPOQuery from '../../components/query/purchase/purOrderPOQuery'
import TablePurOrdPO from '../../components/table/purchase/tablePurOrdPO'
import TableUploadFileOrdPO from '../../components/table/purchase/tableUploadFileOrdPO'
const menuStyle = {}
import { GetMasterQuery } from '../../../features/purchase/purOrdPOLink/getMasterQuery'
import { GetSheetQuery } from '../../../features/purchase/purOrdPOLink/getSheetQuery'
import { getQFileSeq } from './../../../features/basic/daMaterialList/getQFileSeq'

import { PostAUD } from '../../../features/purchase/purOrdPO/postAUD'
import { PostMasterDelete } from '../../../features/purchase/purOrdPO/postMasterDelete'
import { PostSheetDelete } from '../../../features/purchase/purOrdPO/postSheetDelete'
...
export default function PurOrdPOLink({
  permissions,
  isMobile,
  canCreate,
  canEdit,
  ...
  const handleUploadFiles = async (fileList, formCode, pOSeq) => {
    ...
    formData.append('tableName', '_TPUORDPO')
          ...
          <div className="col-start-1 col-end-5 row-start-1 w-full rounded-lg ">
            <div className="flex items-center justify-between mb-2">
              <Title level={4} className="mt-2 uppercase opacity-85 ">
                {t('Nhập đặt mua hàng trong nước')}
              </Title>
              <PurOrderPOActions
