...
import PurDelvInListQuery from '../../components/query/purchase/purDelvInListQuery'
import PurDelvInListActions from '../../components/actions/purchase/purDelvInListActions'
import TablePurDelvInList from '../../components/table/purchase/tablePurDelvInList'
import { GetSheetQuery } from '../../../features/purchase/purDelvInList/getSheetQuery'
...
export default function PurDelvInList({
  permissions,
  isMobile,
  canEdit,
  controllers,
  ...
  useEffect(() => {
    const savedState = localStorage.getItem('detailsStateDelvInList')
  ...
  const handleToggle = (event) => {
    ...
    localStorage.setItem('detailsStateDelvInList', isOpen ? 'open' : 'closed')
  }

  const fetchSPUDelvInListQueryWEB = async () => {
  ...
  return (
    <>
      <Helmet>
        <title>HPM - {t('Truy vấn nhập kho mua hàng trong nước')}</title>
      </Helmet>
          ...
          <div className="col-start-1 col-end-5 row-start-1 w-full rounded-lg ">
            <div className="flex items-center justify-between mb-2">
              <Title level={4} className="mt-2 uppercase opacity-85 ">
                {t('Truy vấn nhập kho mua hàng trong nước')}
              </Title>
              <PurDelvInListActions
                nextPage={nextPage}
                debouncedFetchSPUDelvInListQueryWEB={fetchSPUDelvInListQueryWEB}
              />
            </div>
            <details
