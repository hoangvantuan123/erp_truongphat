...
const menuStyle = {}
import { GetMasterQuery } from '../../../features/purchase/impOrder/getMasterQuery'
import { GetSheetQuery } from '../../../features/purchase/impOrder/getSheetQuery'
...
export default function ImpOrder({
  permissions,
  isMobile,
  canCreate,
  canEdit,
  ...
  useEffect(() => {
    if (id) {
      ...
      if (data) {
        fetchDataFileSeq(data.ApproReqSeq, 'file')
        fetchMasterQuery(data.ApproReqSeq)
        fetchSheetQuery(data.ApproReqSeq)
      }
    }
  }, [id])
  ...
  const fetchMasterQuery = async (approReqSeq) => {
    try {
      const query = [{ ApproReqSeq: approReqSeq }]
  ...
  const fetchSheetQuery = async (approReqSeq) => {
    try {
