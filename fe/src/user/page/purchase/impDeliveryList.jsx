...
import ImpDeliveryListQuery from '../../components/query/purchase/impDeliveryListQuery'
import ImpDeliveryListActions from '../../components/actions/purchase/impDeliveryListActions'
import TableImpDeliveryList from '../../components/table/purchase/tableImpDeliveryList'
import { GetSheetQuery } from '../../../features/purchase/impDeliveryList/getSheetQuery'
...
export default function ImpDeliveryList({
  permissions,
  isMobile,
  canEdit,
  abortControllerRef,
  ...
  const [delvNoTitle, setDelvNoTitle] = useState('')
  ...
  const nextPageDelv = useCallback(() => {
    if (keyPath) {
          ...
          <div className="col-start-1 col-end-5 row-start-1 w-full rounded-lg ">
            <div className="flex items-center justify-between mb-2">
              <Title level={4} className="mt-2 uppercase opacity-85 ">
                {t('Truy vấn nhập kho sản phẩm nhập khẩu')}
              </Title>
              <ImpDeliveryListActions
                nextPageDelv={nextPageDelv}
                nextPageExpense={nextPageExpense}
                debouncedFetchSSLImpDelvInfoQueryWEB={fetchSheetQuery}
              />
            </div>
            <details
