...
import { SACLedgerQueryDetaBalanceQ } from '../../../../features/report/acct/SACLedgerQueryDetaBalanceQ'
import { SACSlipRowSRemDetaBalanceQ } from '../../../../features/report/acct/SACSlipRowSRemDetaBalanceQ'
import AcctDetailedBalanceListAction from '../../../components/actions/report/acct/acctDetailedBalanceListAction'
import AcctDetailedBalanceListQuery from '../../../components/query/report/acct/AcctDetailedBalanceListQuery'
import AcctDetailedBalanceListATable from '../../../components/table/report/acct/acctDetailedBalanceListATable'
import AcctDetailedBalanceListBTable from '../../../components/table/report/acct/acctDetailedBalanceListBTable'
export default function AcctDetailedBalanceList({ permissions, isMobile, canCreate, canEdit, canDelete, controllers,
    cancelAllRequests }) {
    ...
    const defaultColsB = useMemo(() => [
        ...
        { title: t('1404'), id: 'SlipID', kind: 'Text', readonly: false, width: 200, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('36'), id: 'AccDate', kind: 'Text', readonly: false, width: 100, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('1978'), id: 'RegEmpName', kind: 'Text', readonly: false, width: 160, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('593'), id: 'RegDeptName', kind: 'Text', readonly: false, width: 160, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('1646'), id: 'SetSlipNo', kind: 'Text', readonly: false, width: 160, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('8'), id: 'AccName', kind: 'Text', readonly: false, width: 160, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('646'), id: 'Summary', kind: 'Text', readonly: false, width: 200, hasMenu: true, visible: false, trailingRowOptions: { disabled: true } },
        { title: t('1281'), id: 'DrAmt', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('876'), id: 'CrAmt', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('363'), id: 'CurrName', kind: 'Text', readonly: false, width: 90, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('364'), id: 'ExRate', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('1791'), id: 'DrForAmt', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('1789'), id: 'CrForAmt', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('1399'), id: 'SlipKindName', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('549'), id: 'CostDeptName', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('11'), id: 'SetSlipID', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
    ...
    const [colsB, setColsB] = useState(() =>
        loadFromLocalStorageSheet(
            'acct_detailed_balance_list_b_a',
    ...
    const handleSearchData = useCallback(async () => {
        ...
        fetchGenericData({
            controllerKey: 'SACLedgerQueryDetaBalanceQ',
            postFunction: SACLedgerQueryDetaBalanceQ,
            searchParams,
        ...
        fetchGenericData({
            controllerKey: 'SACSlipRowSRemDetaBalanceQ',
            postFunction: SACSlipRowSRemDetaBalanceQ,
            searchParams,
            defaultCols: defaultColsB,
            useEmptyData: false,
            afterFetch: (data) => {
                setGridDataB(data || []);
                setNumRowsB(data?.length || 0);
            },
        });
    }, [
        formData,
                ...
                <div className="flex flex-col  h-full">
                    ...
                    <div className="col-start-1 col-end-5 row-start-2 w-full h-full ">
                        ...
                        <Splitter layout="vertical" className="h-full min-h-0 flex flex-col">
                            <Splitter.Panel defaultSize="10%" min="15%" max="15%" className="h-full min-h-0 flex flex-col">
                                <AcctDetailedBalanceListATable
                            ...
                            <Splitter.Panel defaultSize="85%" min="30%" max="80%" className="h-full min-h-0 flex flex-col">
                                <AcctDetailedBalanceListBTable
