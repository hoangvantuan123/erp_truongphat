...
import { MonthlyFinancialReportQ } from '../../../../features/report/execFin/MonthlyFinancialReportQ'
import MonthlyFinancialReportTable from '../../../components/table/report/execFin/monthlyFinancialReportTable'
import MonthlyFinancialReportQuery from '../../../components/query/report/execFin/MonthlyFinancialReportQuery'
import MonthlyFinancialReportAction from '../../../components/actions/report/execFin/monthlyFinancialReportAction'
export default function MonthlyFinancialReport({ permissions, isMobile, canCreate, canEdit, canDelete, controllers,
    cancelAllRequests }) {
    ...
    const handleSearchData = useCallback(async () => {
        ...
        fetchGenericData({
            controllerKey: 'MonthlyFinancialReportQ',
            postFunction: MonthlyFinancialReportQ,
            searchParams,
