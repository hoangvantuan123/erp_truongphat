...
import { FinancialReportQ } from '../../../../features/report/execFin/FinancialReportQ'
import { GetCodeHelpComboVer2 } from '../../../../features/codeHelp/getCodeHelpComboVer2'
import { GetCodeHelpVer2 } from '../../../../features/codeHelp/getCodeHelpVer2'
import FinancialReportTable from '../../../components/table/report/execFin/financialReportTable'
import FinancialReportAction from '../../../components/actions/report/execFin/financialReportAction'
import FinancialReportQuery from '../../../components/query/report/execFin/financialReportQuery'
import { GetCodeHelpVer3 } from '../../../../features/codeHelp/getCodeHelpVer3'
export default function FinancialReport({ permissions, isMobile, canCreate, canEdit, canDelete, controllers,
    cancelAllRequests }) {
    ...
    const handleSearchData = useCallback(async () => {
        ...
        fetchGenericData({
            controllerKey: 'FinancialReportQ',
            postFunction: FinancialReportQ,
            searchParams,
    ...
    }, [formData, toDate, PrevFrAccYM, PrevToAccYM, FormatSeq, displayLevels, AccUnit, defaultCols, IsDisplayZero, IsInit, PrevIsInit]);
