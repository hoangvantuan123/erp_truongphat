...
import { FSMonthlyProdCostQ } from '../../../../features/report/execFin/FSMonthlyProdCostQ'
import MonthlyProductionCostAction from '../../../components/actions/report/execFin/monthlyProductionCostAction'
import MonthlyProductionCostQuery from '../../../components/query/report/execFin/monthlyProductionCostQuery'
import MonthlyProductionCostTable from '../../../components/table/report/execFin/MonthlyProductionCostTable'
export default function MonthlyProductionCost({ permissions, isMobile, canCreate, canEdit, canDelete, controllers,
    cancelAllRequests }) {
    ...
    const handleSearchData = useCallback(async () => {
        ...
        fetchGenericData({
            controllerKey: 'FSMonthlyProdCostQ',
            postFunction: FSMonthlyProdCostQ,
            searchParams,
