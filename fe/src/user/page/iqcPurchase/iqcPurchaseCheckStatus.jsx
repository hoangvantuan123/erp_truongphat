...
import IqcPurchaseCheckStatusQuery from '../../components/query/iqcPurchase/iqcPurchaseCheckStatusQuery'
import { SearchPageIqcPurchaseCheckStatus } from '../../../features/iqc-purchase/searchPageIqcCheckStatus'
import TopLoadingBar from 'react-top-loading-bar';
import { formatNumberCellSum } from '../../../utils/formatNumberCellSum'
export default function IqcPurchaseCheckStatus({
  permissions,
  isMobile,
  canCreate,
  canEdit,
  ...
  const [cols, setCols] = useState(() =>
    loadFromLocalStorageSheet(
      'S_ERP_COLS_PAGE_IQC_PURCHASE_STATUS_LIST',
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const response = await SearchPageIqcPurchaseCheckStatus(data)
  ...
  const onCellClicked = useCallback(
    (cell, event) => {
      ...
      if (rowIndex >= 0 && rowIndex < gridData.length) {
        ...
        navigate(`/qc/u/iqc-purchase-accept/${encryptedToken}`)
      }
    },
