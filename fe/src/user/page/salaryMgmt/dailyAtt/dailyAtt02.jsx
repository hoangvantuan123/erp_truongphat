...
import DailyAtt02Action from '../../../components/actions/salaryMgmt/dailyAtt/dailyAtt02Action'
import DailyAtt02Table from '../../../components/table/salaryMgmt/dailyAtt/dailyAtt02Table'
...
export default function DailyAtt02Page({ permissions, isMobile, canCreate, canEdit, canDelete, controllers,
    cancelAllRequests }) {
    ...
    const defaultCols = useMemo(() => [
        ...
        { title: t('Tên viết tắt chấm công'), id: 'WkItemSName', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('Số theo vị trí dấu thập phân'), id: 'DecPntCnt', kind: 'Number', readonly: false, width: 80, hasMenu: true, visible: true, trailingRowOptions: { disabled: true }, contentAlign: "right", },
        ...
        { title: t('Chủng loại nhóm hạn mức'), id: 'LimitGrp', kind: 'Text', readonly: false, width: 120, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        { title: t('Phương thức tạo lập'), id: 'WkMth', kind: 'Text', readonly: false, width: 120, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        ...
        { title: t('Đơn vị thời gian'), id: 'TmUnit', kind: 'Text', readonly: false, width: 120, hasMenu: true, visible: true, trailingRowOptions: { disabled: true }, contentAlign: "right", },
        { title: t('Phương thức áp dụng'), id: 'AppMth', kind: 'Text', readonly: false, width: 120, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
        ...
        { title: t('Thứ tự'), id: 'DispSeq', kind: 'Number', readonly: false, width: 60, hasMenu: true, visible: true, trailingRowOptions: { disabled: true }, contentAlign: "right", },
        ...
        { title: t('Ghi chú'), id: 'Remark', kind: 'Text', readonly: false, width: 120, hasMenu: true, visible: true, trailingRowOptions: { disabled: true } },
    ], [t]);
    ...
    const fetchCodeHelpData = useCallback(async () => {
        ...
        try {
            const [res1, res2, res3, res4, res5, res6, res7, res8, res9, res10, res11] = await Promise.allSettled([
                ...
                GetCodeHelpComboVer2('', langCode, 19998, 1, '%', '1003', '', '', '', signal),
            ]);
