...
import DailyAtt03Action from '../../../components/actions/salaryMgmt/dailyAtt/dailyAtt03Action'
import DailyAtt03Table from '../../../components/table/salaryMgmt/dailyAtt/dailyAtt03Table'
...
export default function DailyAtt03Page({ permissions, isMobile, canCreate, canEdit, canDelete, controllers,
    cancelAllRequests }) {
    ...
    const defaultCols = useMemo(() => [
        ...
        { title: t('Tên chấm công'), id: 'WkItemName', kind: 'Text', readonly: false, width: 180, hasMenu: true, visible: true, trailingRowOptions: { disabled: true }, themeOverride: { textHeader: '#DD1144', bgIconHeader: '#DD1144', fontFamily: '' } },
        ...
        { title: t('Thứ tự'), id: 'DispSeq', kind: 'Number', readonly: false, width: 100, hasMenu: true, visible: true, trailingRowOptions: { disabled: true }, contentAlign: "right", },
