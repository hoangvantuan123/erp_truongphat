...
import { GetMasterQuery } from '../../../features/warehouse/lgEtcTransReq/getMasterQuery'
import { GetSheetQuery } from '../../../features/warehouse/lgEtcTransReq/getSheetQuery'
...
export default function LGEtcTransReqLink({
  permissions,
  isMobile,
  canCreate,
  canEdit,
    ...
    try {
      ...
      if (etcOutReqResponse.data.success) {
        ...
        if (data) {
          ...
          setBizUnitTrans(data[0].TransBizUnit)
  ...
  return (
    <>
      <Helmet>
        <title>ITM - {t('Đăng ký yêu cầu di chuyển kho sản phẩm')}</title>
      </Helmet>
