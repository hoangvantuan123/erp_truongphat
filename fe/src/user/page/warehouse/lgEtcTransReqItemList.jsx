...
import LGEtcTransReqItemListQuery from '../../components/query/warehouse/lgEtcTransReqItemListQuery'
import LGEtcTransReqItemListActions from '../../components/actions/warehouse/lgEtcTransReqItemListActions'
import TableLGEtcTransReqItemList from '../../components/table/warehouse/tableLGEtcTransReqItemList'

import { GetSLGInOutReqItemListQuery } from '../../../features/warehouse/lgEtcTransReq/postSLGInOutReqItemListQuery'
...
export default function LGEtcTransReqItemList({
  permissions,
  isMobile,
  canEdit,
  setCollapsed,
  ...
  const [cols, setCols] = useState(() =>
    loadFromLocalStorageSheet(
      'S_ERP_COLS_PAGE_ETC_TRANS_REQ_ITEM_LIST',
  ...
  //   if (keyPath) {
  //     navigate(`/wms/u/warehouse/etc-trans/lg-etc-trans/${keyPath}`)
  //     handClose()
  //   }
  // }, [keyPath, navigate])
  ...
  const nextPage = useCallback(() => {
    if (keyPath) {
      window.open(
        `/wms/u/warehouse/etc-trans/lg-etc-trans/${keyPath}`,
        '_blank',
      )
    }
  }, [keyPath])
          ...
          <div className="col-start-1 col-end-5 row-start-1 w-full rounded-lg ">
            <div className="flex items-center justify-between mb-2">
              <Title level={4} className="mt-2 uppercase opacity-85 ">
                {t('Truy vấn chi tiết yêu cầu di chuyển kho sản phẩm')}
              </Title>
              <LGEtcTransReqItemListActions
                nextPage={nextPage}
