...
import LGEtcTransReqListQuery from '../../components/query/warehouse/lgEtcTransReqListQuery'
import LGEtcTransReqListActions from '../../components/actions/warehouse/lgEtcTransReqListActions'
import TableLGEtcTransReqList from '../../components/table/warehouse/tableLGEtcTransReqList'

import { GetSLGInOutReqListQuery } from '../../../features/warehouse/lgEtcTransReq/postSLGInOutReqListQuery'
import { PostSLGInOutReqListConfirm } from '../../../features/warehouse/lgEtcTransReq/postSLGInOutReqListConfirm'
import { PostSLGInOutReqListStop } from '../../../features/warehouse/lgEtcTransReq/postSLGInOutReqListStop'
...
export default function LGEtcTransReqList({
  permissions,
  isMobile,
  canEdit,
  abortControllerRef,
  ...
  const defaultCols = useMemo(
    () => [
      ...
      {
        title: t('Bộ phận kinh doanh (Kho nhập)'),
        id: 'BizUnitName',
        kind: 'Text',
        readonly: true,
        width: 150,
      ...
      {
        title: t('Bộ phận kinh doanh (Kho xuất)'),
        id: 'TransBizUnitName',
        kind: 'Text',
        readonly: true,
        width: 150,
  ...
  useEffect(() => {
    const savedState = localStorage.getItem('detailsStateLGEtcTransReqList')
  ...
  //   if (keyPath) {
  //     navigate(`/wms/u/warehouse/etc-trans/lg-etc-trans-req/${keyPath}`)
  //   }
  // }, [keyPath, navigate])
  ...
  const nextPage = useCallback(() => {
    if (keyPath) {
      window.open(
        `/wms/u/warehouse/etc-trans/lg-etc-trans-req/${keyPath}`,
        '_blank',
      )
    }
  }, [keyPath])
  ...
  return (
    <>
      <Helmet>
        <title>HPM - {t('Truy vấn yêu cầu di chuyển kho sản phẩm')}</title>
      </Helmet>
          ...
          <div className="col-start-1 col-end-5 row-start-1 w-full rounded-lg ">
            <div className="flex items-center justify-between mb-2">
              <Title level={4} className="mt-2 uppercase opacity-85 ">
                {t('Truy vấn yêu cầu di chuyển kho sản phẩm')}
              </Title>
              <LGEtcTransReqListActions
                nextPage={nextPage}
