...
export default function LGEtcInItemList({
  permissions,
  isMobile,
  canEdit,
  setCollapsed,
  ...
  const nextPage = useCallback(() => {
    if (keyPath) {
      window.open(`/wms/u/warehouse/etc-in/lg-etc-in-link/${keyPath}`, '_blank')
    }
  }, [keyPath])
  //Sheet
  ...
  return (
    <>
      <Helmet>
        <title>HPM - {t('Truy vấn chi tiết nhập kho sản phẩm khác')}</title>
      </Helmet>
