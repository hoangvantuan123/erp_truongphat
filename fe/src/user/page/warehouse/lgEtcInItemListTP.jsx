...
import LGEtcInItemListQuery from '../../components/query/warehouse/lgEtcInItemListQuery'
import LGEtcInItemListActions from '../../components/actions/warehouse/lgEtcInItemListActions'
import TableLGEtcInItemList from '../../components/table/warehouse/tableLGEtcInItemList'
import { GetSLGInOutItemListQuery } from '../../../features/warehouse/postSLGInOutItemListQuery'
...
export default function LGEtcInItemListTP({
  permissions,
  isMobile,
  canEdit,
  setCollapsed,
  ...
  const fetchCodeHelpData = useCallback(async () => {
    ...
    try {
      const [
        ...
        GetCodeHelpCombo('', 6, 19999, 1, '%', '8026', '', '', ''),
        GetCodeHelp(
          10006,
          '',
          bizUnit || '',
  ...
  //   if (keyPath) {
  //     navigate(`/wms/u/warehouse/etc-in/lg-etc-in-link/${keyPath}`)
  //     handClose()
  //   }
  // }, [keyPath, navigate])
  ...
  const nextPage = useCallback(() => {
    if (keyPath) {
      window.open(`/wms/u/warehouse/etc-in/lg-etc-in-tp-link/${keyPath}`, '_blank')
    }
  }, [keyPath])
  //Sheet
  ...
  return (
    <>
      <Helmet>
        <title>ITM - {t('Truy vấn chi tiết nhập kho sản phẩm khác')}</title>
      </Helmet>
      <TopLoadingBar color="blue" height={2} ref={loadingBarRef} />
      <div className="bg-slate-50 p-3  h-[calc(100vh-30px)] overflow-hidden">
        <div className="flex flex-col gap-2 md:grid md:grid-cols-4 md:grid-rows-[auto_1fr] md:gap-4 h-full">
          <div className="col-start-1 col-end-5 row-start-1 w-full rounded-lg ">
            <div className="flex items-center justify-between mb-2">
              <Title level={4} className="mt-2 uppercase opacity-85 ">
                {t('Truy vấn chi tiết nhập kho sản phẩm khác')}
              </Title>
              <LGEtcInItemListActions
                nextPage={nextPage}
