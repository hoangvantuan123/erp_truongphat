...
import LGEtcInReqItemListQuery from '../../components/query/warehouse/lgEtcInReqItemListQuery'
import LGEtcInReqItemListActions from '../../components/actions/warehouse/lgEtcInReqItemListActions'
import TableLGEtcInReqItemList from '../../components/table/warehouse/tableLGEtcInReqItemList'
import { GetSLGInOutReqItemListQuery } from '../../../features/warehouse/postSLGInOutReqItemListQuery'
...
export default function LGEtcInReqItemList({
  permissions,
  isMobile,
  canEdit,
  setCollapsed,
  ...
  //   if (keyPath) {
  //     navigate(`/wms/u/warehouse/etc-in/lg-etc-in/${keyPath}`)
  //     handClose()
  //   }
  // }, [keyPath, navigate])
  ...
  const nextPage = useCallback(() => {
    if (keyPath) {
      window.open(`/wms/u/warehouse/etc-in/lg-etc-in/${keyPath}`, '_blank')
    }
  }, [keyPath])
  //Sheet
  ...
  return (
    <>
      <Helmet>
        <title>HPM - {t('Truy vấn chi tiết yêu cầu nhập kho khác')}</title>
      </Helmet>
          ...
          <div className="col-start-1 col-end-5 row-start-1 w-full rounded-lg ">
            <div className="flex items-center justify-between mb-2">
              <Title level={4} className="mt-2 uppercase opacity-85 ">
                {t('Truy vấn chi tiết yêu cầu nhập kho khác')}
              </Title>
              <LGEtcInReqItemListActions
                nextPage={nextPage}
