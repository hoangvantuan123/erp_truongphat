...
import { GetMasterQuery } from '../../../features/warehouse/lgWHStockRealOpen/getMasterQuery'
import { GetSheetQuery } from '../../../features/warehouse/lgWHStockRealOpen/getSheetQuery'
...
export default function LGWHStockRealOpenLink({
  permissions,
  isMobile,
  canCreate,
  canEdit,
  ...
  return (
    <>
      <Helmet>
        <title>HPM - {t('Đăng ký Kiểm tra tồn kho thực tế')}</title>
      </Helmet>
