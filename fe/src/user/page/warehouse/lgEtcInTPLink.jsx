...
import LGEtcInTPActions from '../../components/actions/warehouse/lgEtcInTPActions'
import LGEtcInTPQuery from '../../components/query/warehouse/lgEtcInTPQuery'
import TableLGEtcInTP from '../../components/table/warehouse/tableLGEtcInTP'

//import { GetSheetQuery } from '../../../features/warehouse/lgEtcInReq/getSheetQuery'
import { GetMasterQuery } from '../../../features/warehouse/lgEtcInTP/getMasterQuery'
import { GetSheetQuery } from '../../../features/warehouse/lgEtcInTP/getSheetQuery'
import { PostAUD } from '../../../features/warehouse/lgEtcInTP/postAUD'
import { PostMasterDelete } from '../../../features/warehouse/lgEtcInTP/postMasterDelete'
import { PostSheetDelete } from '../../../features/warehouse/lgEtcInTP/postSheetDelete'
...
export default function LGEtcInTPLink({
  permissions,
  isMobile,
  canCreate,
  canEdit,
    ...
    try {
      ...
      if (etcInReqResponse.data.success) {
        ...
        if (data) {
          ...
          setWhSeq(data[0].InWHSeq)
          setWhName(data[0].InWHName)
  ...
  const handleResetData = useCallback(async () => {
    ...
    setInOutNo(initialValues.InOutNo)
