...
import LGEtcOutActions from '../../components/actions/warehouse/lgEtcOutActions'
import LGEtcOutQuery from '../../components/query/warehouse/lgEtcOutQuery'
import TableLGEtcOut from '../../components/table/warehouse/tableLGEtcOut'
import TableLGEtcOutItem from '../../components/table/warehouse/tableLGEtcOutItem'

import { Splitter, SplitterPanel } from 'primereact/splitter'

import { GetReqSheetQuery } from '../../../features/warehouse/lgEtcOut/getReqSheetQuery'
import { GetSheetQuery } from '../../../features/warehouse/lgEtcOut/getSheetQuery'
import { PostQRCheck } from '../../../features/warehouse/lgEtcOut/postQRCheck'

import { PostAUD } from '../../../features/warehouse/lgEtcOut/postAUD'
import { PostMasterDelete } from '../../../features/warehouse/lgEtcOut/postMasterDelete'
import { PostSheetDelete } from '../../../features/warehouse/lgEtcOut/postSheetDelete'
...
export default function LGEtcOutLink({
  permissions,
  isMobile,
  canCreate,
  canEdit,
  ...
  const nameFrom = ' XUẤT KHO SẢN PHẨM KHÁC '
  ...
  useEffect(() => {
    workerRef.current = new Worker(
      new URL('../../../workers/workerEtcOut.js', import.meta.url),
    )
  ...
  const fetchSheetQuery = async (reqSeq, inOutSeq) => {
    try {
      ...
      if (etcOutResponse.data.success && inOutResponse?.success) {
        ...
        if (fetchedDataItem.length > 0) {
          ...
          setWhSeq(fetchedDataItem[0].OutWHSeq)
          setWhName(fetchedDataItem[0].OutWHName)
