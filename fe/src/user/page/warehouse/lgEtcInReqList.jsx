...
import LGEtcInReqListQuery from '../../components/query/warehouse/lgEtcInReqListQuery'
import LGEtcInReqListActions from '../../components/actions/warehouse/lgEtcInReqListActions'
import TableLGEtcInReqList from '../../components/table/warehouse/tableLGEtcInReqList'
import { GetSLGInOutReqListQuery } from '../../../features/warehouse/postSLGInOutReqListQuery'
import { PostSLGInOutReqListConfirm } from '../../../features/warehouse/postSLGInOutReqListConfirm'
import { PostSLGInOutReqListStop } from '../../../features/warehouse/postSLGInOutReqListStop'
...
export default function LGEtcInReqList({
  permissions,
  isMobile,
  canEdit,
  controllers,
  ...
  //   if (keyPath) {
  //     navigate(`/wms/u/warehouse/etc-in/lg-etc-in-req/${keyPath}`)
  //   }
  // }, [keyPath, navigate])

  const nextPage = useCallback(() => {
    if (keyPath) {
      window.open(`/wms/u/warehouse/etc-in/lg-etc-in-req/${keyPath}`, '_blank')
    }
  }, [keyPath])
  //Sheet
  ...
  return (
    <>
      <Helmet>
        <title>TMT - {t('Truy vấn yêu cầu nhập kho khác')}</title>
      </Helmet>
          ...
          <div className="col-start-1 col-end-5 row-start-1 w-full rounded-lg ">
            <div className="flex items-center justify-between mb-2">
              <Title level={4} className="mt-2 uppercase opacity-85 ">
                {t('Truy vấn yêu cầu nhập kho khác')}
              </Title>
              <LGEtcInReqListActions
                nextPage={nextPage}
