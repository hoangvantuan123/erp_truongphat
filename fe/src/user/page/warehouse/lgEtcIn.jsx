    ...
    try {
      ...
      if (etcInResponse.data.success) {
        ...
        if (fetchedData.length > 0) {
          ...
          setReqSeq(fetchedData[0].ReqSeq)
          setEtcReqNo(fetchedData[0].ReqNo)
          setCustName(fetchedData[0].CustName)
          setCustSeq(fetchedData[0].CustSeq)
          setWhSeq(fetchedData[0].InWHSeq)
          setWhName(fetchedData[0].InWHName)
