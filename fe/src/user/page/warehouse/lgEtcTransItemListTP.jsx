...
import LGEtcTransItemListQuery from '../../components/query/warehouse/lgEtcTransItemListQuery'
import LGEtcTransItemListActions from '../../components/actions/warehouse/lgEtcTransItemListActions'
import TableLGEtcTransItemList from '../../components/table/warehouse/tableLGEtcTransItemList'

import { GetSLGInOutItemListQuery } from '../../../features/warehouse/lgEtcTrans/postSLGInOutItemListQuery'
...
export default function LGEtcTransItemListTP({
  permissions,
  isMobile,
  canEdit,
  setCollapsed,
  ...
  const [cols, setCols] = useState(() =>
    loadFromLocalStorageSheet(
      'S_ERP_COLS_PAGE_ETC_TRANS_ITEM_LIST',
  ...
  //   if (keyPath) {
  //     navigate(`/wms/u/warehouse/etc-trans/lg-etc-trans-link/${keyPath}`)
  //     handClose()
  //   }
  // }, [keyPath, navigate])
  ...
  const nextPage = useCallback(() => {
    if (keyPath) {
      window.open(
        `/wms/u/warehouse/etc-trans/lg-etc-trans-tp-link/${keyPath}`,
        '_blank',
      )
    }
  }, [keyPath])
