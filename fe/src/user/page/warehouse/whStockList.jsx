...
import WHStockListQuery from '../../components/query/warehouse/whStockListQuery'
import WHStockListActions from '../../components/actions/warehouse/whStockListActions'
import TableWHStockList from '../../components/table/warehouse/tableWHStockList'
import { SLGWHStockListDynamicQueryWeb } from '../../../features/warehouse/postWHStockList'
...
export default function WHStockList({ permissions, isMobile, controllers }) {
  ...
  const defaultCols = [
    ...
    {
      title: t('Số lượng thiếu an toàn'),
      id: 'LackQty',
      kind: 'Text',
      readonly: true,
      width: 120,
  ...
  const fetchSLGWHStockListDynamicQueryWeb = async () => {
    ...
    try {
      ...
      const response = await SLGWHStockListDynamicQueryWeb(formA)
  ...
  return (
    <>
      <Helmet>
        <title>HPM - {t('Tồn kho tại kho')}</title>
      </Helmet>
