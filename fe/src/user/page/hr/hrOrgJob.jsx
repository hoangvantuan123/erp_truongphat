...
import HrBasOrgJobTable from '../../components/table/hr/hrBasOrgJob'
import HrBasTOrgJobQuery from '../../components/query/hr/hrBasOrgJobQuery'
import HrBasOrgJobAction from '../../components/actions/hr/hrBasOrgJob'
import { PostUHrBasOrgJob } from '../../../features/hr/hrBasOrgJob/postUHrBasOrgJob'
import { PostAHrBasOrgJob } from '../../../features/hr/hrBasOrgJob/postAHrBasOrgJob'
import { PostDHrBasOrgJob } from '../../../features/hr/hrBasOrgJob/postDHrBasOrgJob'
import { PostQHrBasOrgJob } from '../../../features/hr/hrBasOrgJob/postQHrBasOrgJob'
import { HandleError } from '../default/handleError'
import dayjs from 'dayjs'
import ErrorListModal from '../default/errorListModal'
export default function HrOrgJob({ permissions, isMobile, canCreate, canEdit, canDelete, controllers,
    cancelAllRequests }) {
    ...
    const defaultCols = useMemo(() => [
        ...
        {
            title: 'Tên viết tắt bằng tiếng Anh',
            id: 'AbrJobEngName',
            kind: 'Text',
            readonly: false,
            width: 200,
        ...
        {
            title: 'Phân loại theo chức vụ',
            id: 'UMJobHighClassName',
            kind: 'Text',
            readonly: false,
            width: 200,
            hasMenu: true,
        ...
        },
        {
            ...
            width: 250,
            hasMenu: true,
            visible: true, trailingRowOptions: { disabled: true },
        },
        {
            title: 'Thứ tự',
            id: 'DispSeq',
    ...
    const fetchCodeHelpData = useCallback(async () => {
        ...
        try {
            ...
            const [help01, help02, help03, help04, help05, help06] = await Promise.all([
                ...
                GetCodeHelpVer2(19999, '', '3009', '', '', '', '', 1, 0, '', 0, 0, 0, signal),
    ...
    const handleSearchData = useCallback(async () => {
        ...
        fetchGenericData({
            controllerKey: 'PostQHrBasOrgJob',
            postFunction: PostQHrBasOrgJob,
            searchParams,
            useEmptyData: true,
            afterFetch: (data) => {
                setGridData(data);
    ...
    }, [dataSearch, dataSearch1, formData, toDate, JobName])
    ...
    const handleDeleteDataSheet = useCallback(
        (e) => {
            ...
            if (rowsWithStatusD.length > 0) {
                ...
                PostDHrBasOrgJob(rowsWithStatusD)
                    .then((response) => {
                        if (response.success) {
    ...
    const handleSaveData = useCallback(async () => {
        ...
        try {
            const apiCalls = [];
            if (resulA.length > 0) apiCalls.push(PostAHrBasOrgJob(resulA));
            if (resulU.length > 0) apiCalls.push(PostUHrBasOrgJob(resulU));
            ...
            setGridData(prev => {
                const updated = prev.map(item => {
                    ...
                    return found ? { ...item, Status: '', JobSeq: found.JobSeq } : item;
                });
