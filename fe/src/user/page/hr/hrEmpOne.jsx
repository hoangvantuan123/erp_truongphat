...
import HrEmpTableOne from '../../components/table/hr/hrEmpTableOne'
import HrEmpsOneQuery from '../../components/query/hr/hrEmpOneQuery'
import HrEmpsOneActions from '../../components/actions/hr/hrEmpOneAction'
...
export default function HrEmps({ permissions, isMobile, canCreate, canEdit, canDelete, controllers,
    ...
    const defaultCols = useMemo(() => [
        ...
        {
            title: 'Mã nhân viên', id: 'EmpID', kind: 'Text', readonly: false, width: 180, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            },
        },
        {
            title: 'Nhân viên', id: 'EmpName', kind: 'Text', readonly: false, width: 200, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            },
            themeOverride: {
                textHeader: '#DD1144',
        ...
        {
            title: 'Phân loại làm việc/nghỉ việc', id: 'EntRetTypeName', kind: 'Text', readonly: false, width: 220, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
        ...
        {
            title: 'Phân loại nhân viên', id: 'UMEmpTypeName', kind: 'Text', readonly: false, width: 200, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
            title: 'Ngày vào', id: 'EntDate', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
            title: 'Chiều cao', id: 'Height', kind: 'Number', readonly: false, width: 120, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
            title: 'Cân nặng', id: 'Weight', kind: 'Number', readonly: false, width: 120, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
            title: 'Thị lực (trái)', id: 'EyeLt', kind: 'Number', readonly: false, width: 120, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
            title: 'Thị lực (phải)', id: 'EyeRt', kind: 'Number', readonly: false, width: 120, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
            title: 'Nhóm máu', id: 'SMBloodTypeName', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
            title: 'Người khuyết tật', id: 'IsDisabled', kind: 'Boolean', readonly: false, width: 160, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
            title: 'Người nước ngoài', id: 'IsForeigner', kind: 'Boolean', readonly: false, width: 160, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
            title: 'Dương/Âm', id: 'SMBirthTypeName', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
            title: 'Ngày sinh', id: 'BirthDate', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
            title: 'Quốc tịch', id: 'UMNationName', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
            title: 'Giới tính', id: 'SMSexSeqName', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
            title: 'Kết hôn', id: 'IsMarriage', kind: 'Boolean', readonly: false, width: 120, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
            title: 'Ngày cưới', id: 'MarriageDate', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
            title: 'Tôn giáo', id: 'UMReligionName', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
            title: 'Sở thích', id: 'Hobby', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
            title: 'Đặc biệt', id: 'Speciality', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
            title: 'Số điện thoại', id: 'Phone', kind: 'Text', readonly: false, width: 150, hasMenu: true, visible: true, trailingRowOptions: {
                disabled: true,
            }
        },
        {
