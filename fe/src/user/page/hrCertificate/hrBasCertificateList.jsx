...
import HrBasCetificateListQuery from '../../components/query/hrCertificate/hrBasCetificateListQuery'
import TableHrBasCertificateList from '../../components/table/hr-certificate/tableHrBasCertificateList'
import { SearchBasCertificateList } from '../../../features/mgn-hr/hr-certificate/searchBasCertificateList'
export default function HrBasCertificateList({
  permissions,
  isMobile,
  canCreate,
  canEdit,
  ...
  const [fromDateQ, setFromDateQ] = useState(dayjs().startOf('month'))
      ...
      const data = [
        {
          ...
          FrIssueDate: formatDateSearch(fromDateQ),
          ToIssueDate: formatDateSearch(toDateQ),
          IsAgree: IsAgree,
          IsPrt: IsPrt,
        }
      ]

      const response = await SearchBasCertificateList(data)
  ...
  }, [empSeq, fromDateQ, toDateQ, SMCertiType, IsAgree, IsPrt])
