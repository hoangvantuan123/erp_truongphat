...
function TableHrLaborContractPrint({
  dataUser,
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('HR_LABOR_CONTRACT_PRINT_H', [])
  })
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('HR_LABOR_CONTRACT_PRINT_H', newHidden)
      return newHidden
    })
  }
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('HR_LABOR_CONTRACT_PRINT', uniqueCols)
      return uniqueCols
    })
  }
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('HR_LABOR_CONTRACT_PRINT')
    localStorage.removeItem('HR_LABOR_CONTRACT_PRINT_H')
    setShowMenu(null)
  }
  ...
  const onColumnMoved = useCallback((startIndex, endIndex) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('HR_LABOR_CONTRACT_PRINT', updatedCols)
      return updatedCols
    })
  }, [])
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('HR_LABOR_CONTRACT_PRINT', newCols)
        return newCols
      })
      setHiddenColumns((prevHidden) => {
...
export default TableHrLaborContractPrint
