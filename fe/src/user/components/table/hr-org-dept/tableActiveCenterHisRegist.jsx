...
import { CellsCCtrName } from '../../sheet/cells/cellsCCtrName'
import { updateEditedRows } from '../../sheet/js/updateEditedRows'
function TableActiveCenterHisRegist({
  CCtrData,
  setSelection,
  selection,
  setShowSearch,
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('ORG_DEPT_CENTER_H', [])
  })
  ...
  const columnNames = ['CCtrName']
  const grayColumns = ['SMStatusName', 'ToolNo']
  ...
  const getData = useCallback(
    ([col, row]) => {
      ...
      const cellConfig = {
        CCtrName: {
          kind: 'cells-cctr-name',
          allowedValues: CCtrData,
      ...
      if (columnKey === 'BegYm' || columnKey === 'EndYm') {
        return {
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('ORG_DEPT_CENTER_H', newHidden)
      return newHidden
    })
  }
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('ORG_DEPT_CENTER', uniqueCols)
      return uniqueCols
    })
  }
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('ORG_DEPT_CENTER')
    localStorage.removeItem('ORG_DEPT_CENTER_H')
    setShowMenu(null)
  }
  ...
  const onColumnMoved = useCallback((startIndex, endIndex) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('ORG_DEPT_CENTER', updatedCols)
      return updatedCols
    })
  }, [])
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('ORG_DEPT_CENTER', newCols)
        return newCols
      })
      setHiddenColumns((prevHidden) => {
    ...
    <div className="w-full  h-full flex items-center justify-center">
      <div className="w-full h-full flex flex-col bg-white  overflow-x-hidden overflow-hidden ">
        <DataEditor
          ...
          isDraggable={false}
          onCellClicked={onCellClickedDeptOrg}
...
export default TableActiveCenterHisRegist
