...
function TableInfoMultiEmpList({
  setSelection,
  selection,
  setShowSearch,
  showSearch,
...
const dateFormat = (date) => {
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('INFO_MULTI_EMP_LIST_H', [])
  })
  ...
  const getData = useCallback(
    ([col, row]) => {
      ...
      if (
        columnKey === 'PrevMMCnt' ||
        columnKey === 'CurrEntCnt' ||
        columnKey === 'CurrRetCnt' ||
        columnKey === 'CurrMMCnt' 
      ) {
        return {
      ...
      if (
        columnKey === 'IsExPrb'||
        columnKey === 'IsDisabled'||
        columnKey === 'IsPatVet'||
        columnKey === 'IsForeigner'||
        columnKey === 'IsMarriage'
      ...
      if (columnKey === 'OrdDate' || 
        columnKey === 'GrpEntDate' ||
        columnKey === 'EntDate'||
        columnKey === 'RetireDate'||
        columnKey === 'WkEntDate'||
        columnKey === 'NextPsOrdDate' ||
        columnKey === 'NextJpOrdDate' ||
        columnKey === 'DeptOrdDate' ||
        columnKey === 'JpOrdDate' ||
        columnKey === 'PgOrdDate' ||
        columnKey === 'JdOrdDate' ||
        columnKey === 'PsOrdDate' ||
        columnKey === 'GrdYm' ||
        columnKey === 'BirthDate' ||
        columnKey === 'MarriageDate' ||
        columnKey === 'NextPsOrdDate' ||
        columnKey === 'YyOccurDate' ||
        columnKey === 'WkDate' ||
        columnKey === 'RetDate' || 
        columnKey === 'RetEmpDate'
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('INFO_MULTI_EMP_LIST_H', newHidden)
      return newHidden
    })
  }
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('INFO_MULTI_EMP_LIST', uniqueCols)
      return uniqueCols
    })
  }
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('INFO_MULTI_EMP_LIST')
    localStorage.removeItem('INFO_MULTI_EMP_LIST_H')
    setShowMenu(null)
  }
  ...
  const onColumnMoved = useCallback((startIndex, endIndex) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('INFO_MULTI_EMP_LIST', updatedCols)
      return updatedCols
    })
  }, [])
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('INFO_MULTI_EMP_LIST', newCols)
        return newCols
      })
      setHiddenColumns((prevHidden) => {
    ...
    <div className="w-full  h-full flex items-center justify-center">
      <div className="w-full h-full flex flex-col bg-white  overflow-x-hidden overflow-hidden ">
        ...
        <DataEditor
          ...
          onCellClicked={onCellClickedDepNew}
...
export default TableInfoMultiEmpList
