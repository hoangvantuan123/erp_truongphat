...
import HrEduLecturerOutsiteQuery from '../../query/hrEdu/hrEduLecturerOutsiteQuery'

function TableHrEduLecturerOutsite({
  payTypeData,
  setPayTypeData,
  setPayType,
  setPayTypeName,
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('HR_EDU_OUTSITE', [])
  })
  ...
  const columnNames = ['SMPayTypeName']
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('HR_EDU_OUTSITE', newHidden)
      return newHidden
    })
  }
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('HR_EDU_OUTSITE_h', uniqueCols)
      return uniqueCols
    })
  }
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('HR_EDU_OUTSITE_h')
    localStorage.removeItem('HR_EDU_OUTSITE')
  }
  ...
  const onColumnMoved = useCallback((startIndex, endIndex) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('HR_EDU_OUTSITE_h', updatedCols)
      return updatedCols
    })
  }, [])
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('HR_EDU_OUTSITE_h', newCols)
        return newCols
      })
      setHiddenColumns((prevHidden) => {
...
export default TableHrEduLecturerOutsite
