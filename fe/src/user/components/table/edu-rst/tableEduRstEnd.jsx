...
function TableEduRstEnd({
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('EDU_RST_LIST', [])
  })
  ...
  const getData = useCallback(
    ([col, row]) => {
      ...
      if (columnKey === 'IsEnd' || columnKey === 'IsBatchReq') {
      ...
      if (
        columnKey === 'RegDate' ||
        columnKey === 'EduBegDate' ||
        columnKey === 'EduEndDate'
      ) {
        let displayValue = ''
        let dataValue = value
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('EDU_RST_LIST', newHidden)
      return newHidden
    })
  }
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('EDU_RST_LIST_h', uniqueCols)
      return uniqueCols
    })
  }
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('EDU_RST_LIST_h')
    localStorage.removeItem('EDU_RST_LIST')
  }
  ...
  const onColumnMoved = useCallback((startIndex, endIndex) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('EDU_RST_LIST_h', updatedCols)
      return updatedCols
    })
  }, [])
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('EDU_RST_LIST_h', newCols)
        return newCols
      })
      setHiddenColumns((prevHidden) => {
