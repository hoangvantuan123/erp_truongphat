...
function Emp13Table({
    ...
    const [hiddenColumns, setHiddenColumns] = useState(() => {
        return loadFromLocalStorageSheet('emp_13_h', [])
    })
    ...
    const getData = useCallback(
        ([col, row]) => {
            ...
            const cellConfig = {
                UMChrgWkName: {
                    ...
                    allowedValues: helpData23,
                    setCacheData: setHelpData23,
                },
                UMPjtTypeName: {
                    kind: 'cell-UMPjtTypeName',
                    allowedValues: helpData24,
                    setCacheData: setHelpData24,
                },
                JobName: {
                    kind: 'cell-JobName',
                    allowedValues: helpData25,
                    setCacheData: setHelpData25,
                },
        ...
        [gridData, cols, helpData23, helpData24, helpData25]
    )
    ...
    const updateHiddenColumns = (newHiddenColumns) => {
        setHiddenColumns((prevHidden) => {
            ...
            saveToLocalStorageSheet('emp_13_h', newHidden)
            return newHidden
        })
    }
    ...
    const updateVisibleColumns = (newVisibleColumns) => {
        setCols((prevCols) => {
            ...
            saveToLocalStorageSheet('emp_13_a', uniqueCols)
            return uniqueCols
        })
    }
    ...
    const handleReset = () => {
        ...
        setHiddenColumns([])
        localStorage.removeItem('emp_13_a')
        localStorage.removeItem('emp_13_h')
    }
    ...
    const onColumnMoved = useCallback((startIndex, endIndex) => {
        setCols((prevCols) => {
            ...
            saveToLocalStorageSheet('emp_13_a', updatedCols)
            return updatedCols
        })
    }, [])
    ...
    const showDrawer = () => {
        ...
        const currentVisibleCols = loadFromLocalStorageSheet('emp_13_a', []).map(
            (col) => col.id
        )
    ...
    const handleCheckboxChange = (columnId, isChecked) => {
        if (isChecked) {
            ...
            setCols((prevCols) => {
                ...
                saveToLocalStorageSheet('emp_13_a', newCols)
                return newCols
            })
            setHiddenColumns((prevHidden) => {
    ...
    const onCellEdited = useCallback(
        ...
        [cols, gridData, helpData23, helpData24, helpData25]
    )
    return (
