...
function Emp12Table({
    ...
    const [hiddenColumns, setHiddenColumns] = useState(() => {
        return loadFromLocalStorageSheet('emp_12_h', [])
    })
    ...
    const getData = useCallback(
        ([col, row]) => {
            ...
            const cellConfig = {
                ...
                UMChrgWkName: {
                    ...
                    allowedValues: helpData21,
                    setCacheData: setHelpData21,
                },
                UMRetReasonName: {
                    kind: 'cell-UMRetReasonName',
                    allowedValues: helpData22,
                    setCacheData: setHelpData22,
                },
            }
        ...
        [gridData, cols, helpData21, helpData22]
    )
    ...
    const updateHiddenColumns = (newHiddenColumns) => {
        setHiddenColumns((prevHidden) => {
            ...
            saveToLocalStorageSheet('emp_12_h', newHidden)
            return newHidden
        })
    }
    ...
    const updateVisibleColumns = (newVisibleColumns) => {
        setCols((prevCols) => {
            ...
            saveToLocalStorageSheet('emp_12_a', uniqueCols)
            return uniqueCols
        })
    }
    ...
    const handleReset = () => {
        ...
        setHiddenColumns([])
        localStorage.removeItem('emp_12_a')
        localStorage.removeItem('emp_12_h')
    }
    ...
    const onColumnMoved = useCallback((startIndex, endIndex) => {
        setCols((prevCols) => {
            ...
            saveToLocalStorageSheet('emp_12_a', updatedCols)
            return updatedCols
        })
    }, [])
    ...
    const showDrawer = () => {
        ...
        const currentVisibleCols = loadFromLocalStorageSheet('emp_12_a', []).map(
            (col) => col.id
        )
    ...
    const handleCheckboxChange = (columnId, isChecked) => {
        if (isChecked) {
            ...
            setCols((prevCols) => {
                ...
                saveToLocalStorageSheet('emp_12_a', newCols)
                return newCols
            })
            setHiddenColumns((prevHidden) => {
    ...
    const onCellEdited = useCallback(
        ...
        [cols, gridData, helpData21, helpData22]
    )
    return (
        <div className="w-full gap-1 h-full flex items-center justify-center">
            <div className="w-full h-full flex flex-col  bg-white  overflow-hidden ">
                <h2 className="text-[10px]  text-blue-600 border-b font-medium flex items-center gap-2 p-2  uppercase">
                    Đăng ký hạng mục kinh nghiệm bên ngoài
                </h2>
                <DataEditor
                    {...cellProps}
                    ref={gridRef}
