      ...
      if (key === 'TestValue') {
        if (newValue.kind === GridCellKind.Text) {
          setGridData((prev) => {
            ...
            if (
              product.UpperLimit === null ||
              product.UpperLimit === '' ||
              product.LowerLimit === null ||
              product.LowerLimit === '' ||
              selectedName <= product.UpperLimit && selectedName >= product.LowerLimit
            ) {
              product['SMTestResultName1'] = 'Đạt'
              product['SMTestResultName'] = 6035003
            } else {
              product['SMTestResultName1'] = 'Không đạt'
              product['SMTestResultName'] = 6035004
            }
            product['TestValue'] = selectedName
        ...
        if (newValue.kind === GridCellKind.Number) {
          setGridData((prev) => {
            ...
            if (
              ...
              message.error('Không thể nhỏ hơn 0')
              product['QCTitleBadQty'] = 0
            } else {
              product['QCTitleBadQty'] = selectedName
            }
...
export default TableIqcItemReq
