...
function TableIqcDetailsListReq({
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('H_ERP_COLS_PAGE_IQC_REQ_LIST_DETAILS', [])
  })
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('H_ERP_COLS_PAGE_IQC_REQ_LIST_DETAILS', newHidden)
      return newHidden
    })
  }
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('S_ERP_COLS_PAGE_IQC_REQ_LIST_DETAILS')
    localStorage.removeItem('H_ERP_COLS_PAGE_IQC_REQ_LIST_DETAILS')
    setShowMenu(null)
  }
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('S_ERP_COLS_PAGE_IQC_REQ_LIST_DETAILS', newCols)
        return newCols
      })
      setHiddenColumns((prevHidden) => {
        const newHidden = prevHidden.filter((id) => id !== columnId)
        saveToLocalStorageSheet(
          'H_ERP_COLS_PAGE_IQC_REQ_LIST_DETAILS',
          newHidden,
        )
        return newHidden
      })
...
export default TableIqcDetailsListReq
