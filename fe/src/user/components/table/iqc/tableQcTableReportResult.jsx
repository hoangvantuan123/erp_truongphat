...
function TableQcTestReportResult({
  setSelection,
  selection,
  setShowSearch,
  showSearch,
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('H_ERP_COLS_PAGE_QC_REPORT_RESULT', [])
  })
  ...
  const onCellEdited = useCallback(
    async (cell, newValue) => {
      ...
      if (key === 'IdSeq' || key === 'BadItemCnt' || key === 'SampleNoSheet') {
        return
      }
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('H_ERP_COLS_PAGE_QC_REPORT_RESULT', newHidden)
      return newHidden
    })
  }
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_QC_REPORT_RESULT', uniqueCols)
      return uniqueCols
    })
  }
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('S_ERP_COLS_PAGE_QC_REPORT_RESULT')
    localStorage.removeItem('H_ERP_COLS_PAGE_QC_REPORT_RESULT')
    setShowMenu(null)
  }
  ...
  const onColumnMoved = useCallback((startIndex, endIndex) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_QC_REPORT_RESULT', updatedCols)
      return updatedCols
    })
  }, [])
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('S_ERP_COLS_PAGE_QC_REPORT_RESULT', newCols)
        return newCols
      })
      setHiddenColumns((prevHidden) => {
...
export default TableQcTestReportResult
