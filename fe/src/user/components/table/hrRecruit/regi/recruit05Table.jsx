...
import { Cells30009 } from '../../../sheet/cells/cells30009'
import { Cells30010 } from '../../../sheet/cells/cells30010'
import { Cells30011 } from '../../../sheet/cells/cells30011'
import moment from 'moment'

function Recruit05Table({
    setSelection,
    selection,
    setShowSearch,
    showSearch,
    ...
    const [hiddenColumns, setHiddenColumns] = useState(() => {
        return loadFromLocalStorageSheet('recruitment05_h', [])
    })
    ...
    const onCellEdited = useCallback(
                ...
                if (newValue.kind === GridCellKind.Custom) {
                    setGridData((prev) => {
                        ...
                        if (selectedName) {
                            ...
                            product['LanguageSeq'] = selectedName.IdSeq
                        } else {
                            product[cols[col].id] = ''
                            product['LanguageSeq'] = ''
                        }
            ...
            if (key === 'CertifiTypeName') {
                if (newValue.kind === GridCellKind.Custom) {
                    setGridData((prev) => {
                        ...
                        if (selectedName) {
                            product[cols[col].id] = selectedName.DefineItemName
                            product['CertifiTypeSeq'] = selectedName.IdSeq
                        } else {
                            product[cols[col].id] = ''
                            product['CertifiTypeSeq'] = ''
                        }
            ...
            if (key === 'ProfiLevelName') {
                if (newValue.kind === GridCellKind.Custom) {
                    setGridData((prev) => {
                        ...
                        if (selectedName) {
                            product[cols[col].id] = selectedName.DefineItemName
                            product['ProfiLevelSeq'] = selectedName.IdSeq
                        } else {
                            product[cols[col].id] = ''
                            product['ProfiLevelSeq'] = ''
                        }
        ...
        [cols, gridData, helpData01, helpData02, helpData03, helpData04, canEdit]
    )
    ...
    const updateHiddenColumns = (newHiddenColumns) => {
        setHiddenColumns((prevHidden) => {
            ...
            saveToLocalStorageSheet('recruitment05_h', newHidden)
            return newHidden
        })
    }
    ...
    const updateVisibleColumns = (newVisibleColumns) => {
        setCols((prevCols) => {
            ...
            saveToLocalStorageSheet('recruitment05_a', uniqueCols)
            return uniqueCols
        })
    }
    ...
    const handleReset = () => {
        ...
        setHiddenColumns([])
        localStorage.removeItem('recruitment05_a')
        localStorage.removeItem('recruitment05_h')
    }
    ...
    const onColumnMoved = useCallback((startIndex, endIndex) => {
        setCols((prevCols) => {
            ...
            saveToLocalStorageSheet('recruitment05_a', updatedCols)
            return updatedCols
        })
    }, [])
    ...
    const showDrawer = () => {
        ...
        const currentVisibleCols = loadFromLocalStorageSheet('recruitment05_a', []).map(
            (col) => col.id
        )
    ...
    const handleCheckboxChange = (columnId, isChecked) => {
        if (isChecked) {
            ...
            setCols((prevCols) => {
                ...
                saveToLocalStorageSheet('recruitment05_a', newCols)
                return newCols
            })
            setHiddenColumns((prevHidden) => {
            ...
            <div className="w-full h-full flex flex-col  bg-white  overflow-hidden ">
                ...
                <DataEditor
                    ...
                    customRenderers={[CellsEmpSPInterview,
                        Cells30009, Cells30010, Cells30011
                    ]}
                />
                {showMenu !== null &&
                    renderLayer(
