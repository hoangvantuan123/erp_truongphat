...
import { Cells30008 } from '../../../sheet/cells/cells30008'
import moment from 'moment'

function Recruit04Table({
    setSelection,
    selection,
    setShowSearch,
    showSearch,
    ...
    const [hiddenColumns, setHiddenColumns] = useState(() => {
        return loadFromLocalStorageSheet('recruitment04_h', [])
    })
    ...
    const getData = useCallback(
        ([col, row]) => {
            ...
            if (columnKey === "ResidID" || columnKey === "NationalId" || columnKey === "DateOfBirth" || columnKey === "PhoneNumber") {
                ...
                if (newValue.kind === GridCellKind.Custom) {
                    setGridData((prev) => {
                        ...
                        if (selectedName) {
                            ...
                            product['FamilyTypeSeq'] = selectedName.IdSeq
                        } else {
                            product[cols[col].id] = ''
                            product['FamilyTypeSeq'] = ''
                        }
    ...
    const updateHiddenColumns = (newHiddenColumns) => {
        setHiddenColumns((prevHidden) => {
            ...
            saveToLocalStorageSheet('recruitment04_h', newHidden)
            return newHidden
        })
    }
    ...
    const updateVisibleColumns = (newVisibleColumns) => {
        setCols((prevCols) => {
            ...
            saveToLocalStorageSheet('recruitment04_a', uniqueCols)
            return uniqueCols
        })
    }
    ...
    const handleReset = () => {
        ...
        setHiddenColumns([])
        localStorage.removeItem('recruitment04_a')
        localStorage.removeItem('recruitment04_h')
    }
    ...
    const onColumnMoved = useCallback((startIndex, endIndex) => {
        setCols((prevCols) => {
            ...
            saveToLocalStorageSheet('recruitment04_a', updatedCols)
            return updatedCols
        })
    }, [])
    ...
    const showDrawer = () => {
        ...
        const currentVisibleCols = loadFromLocalStorageSheet('recruitment04_a', []).map(
            (col) => col.id
        )
    ...
    const handleCheckboxChange = (columnId, isChecked) => {
        if (isChecked) {
            ...
            setCols((prevCols) => {
                ...
                saveToLocalStorageSheet('recruitment04_a', newCols)
                return newCols
            })
            setHiddenColumns((prevHidden) => {
