...
function Tablepdsf1573({
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('pdsfc_work_report_1573_ah', [])
  })
  ...
  const columnNames = ['ToolName', 'SMStatusName', 'EmpName', 'ToolNo'];
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('pdsfc_work_report_1573_ah', newHidden)
      return newHidden
    })
  }
  ...
  const handleReset = () => {
    ...
    localStorage.removeItem('pdsfc_work_report_1573_ah')
    setShowMenu(null)
  }
