...
function TablepdsfcWorkReportList({
  setSelection,
  selection,
  setShowSearch,
  showSearch,
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('pdsfc_work_report_list_ah', [])
  })
  ...
  const getData = useCallback(
    ([col, row]) => {
      ...
      if (columnKey === "ProdQty" || columnKey === "OKQty" || columnKey === "BadQty"
        || columnKey === "ReOrderQty" || columnKey === "StdUnitProdQty"
        || columnKey === "StdUnitOKQty" || columnKey === "StdUnitBadQty" || columnKey === "StdUnitReOrderQty"
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('pdsfc_work_report_list_ah', newHidden)
      return newHidden
    })
  }
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('pdsfc_work_report_list_a', uniqueCols)
      return uniqueCols
    })
  }
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('pdsfc_work_report_list_a')
    localStorage.removeItem('pdsfc_work_report_list_ah')
    setShowMenu(null)
  }
  ...
  const onColumnMoved = useCallback((startIndex, endIndex) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('pdsfc_work_report_list_a', updatedCols)
      return updatedCols
    })
  }, [])
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('pdsfc_work_report_list_a', newCols)
        return newCols
      })
      setHiddenColumns((prevHidden) => {
...
export default TablepdsfcWorkReportList
