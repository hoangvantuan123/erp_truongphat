...
function TableIqcOutsourceReqList({
  dataUnit,
  setSelection,
  selection,
  setShowSearch,
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet(
      'H_ERP_COLS_PAGE_IQC_OUTSOURCE_LIST_DETAILS',
      [],
    )
  })
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('S_ERP_COLS_PAGE_IQC_OUTSOURCE_LIST_DETAILS')
    localStorage.removeItem('H_ERP_COLS_PAGE_IQC_OUTSOURCE_LIST_DETAILS')
    setShowMenu(null)
  }
...
export default TableIqcOutsourceReqList
