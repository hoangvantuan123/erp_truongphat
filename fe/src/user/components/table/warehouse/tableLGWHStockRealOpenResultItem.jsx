...
function TableLGWHStockRealOpenResultItem({
  setSelection,
  selection,
  setShowSearch,
  showSearch,
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet(
      'H_ERP_COLS_PAGE_STOCK_REAL_OPEN_RESULT_ITEM',
      [],
    )
  })
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('S_ERP_COLS_PAGE_STOCK_REAL_OPEN_RESULT_ITEM')
    localStorage.removeItem('H_ERP_COLS_PAGE_STOCK_REAL_OPEN_RESULT_ITEM')
  }
    ...
    <div className="w-full h-full flex flex-col bg-white overflow-hidden pb-[59px]">
      <div className="w-full h-full flex flex-col border bg-white rounded-lg overflow-hidden ">
        <h2 className="text-xs border-b font-medium flex items-center gap-2 p-2 text-blue-600 uppercase">
          <TableOutlined />
          THÔNG TIN KẾT QUẢ KIỂM TRA TỒN KHO THỰC TẾ
        </h2>
            ...
            >
              {showMenu.menuType === 'statusMenu' ? (
                <LayoutStatusMenuSheetNew
                  ...
                  fileName="StockRealOpenResultItem"
...
export default TableLGWHStockRealOpenResultItem
