...
function TableLGEtcOutReqItemList({
  data,
  setSelection,
  selection,
  setShowSearch,
  ...
  const [hiddenColumns, setHiddenColumns] = useState(
    loadFromLocalStorageSheet('H_ERP_COLS_PAGE_ETC_OUT_REQ_ITEM_LIST', []),
  )
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet(
        'H_ERP_COLS_PAGE_ETC_OUT_REQ_ITEM_LIST',
        newHidden,
      )
      return newHidden
    })
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('S_ERP_COLS_PAGE_ETC_OUT_REQ_ITEM_LIST')
    localStorage.removeItem('H_ERP_COLS_PAGE_ETC_OUT_REQ_ITEM_LIST')
  }
...
export default TableLGEtcOutReqItemList
