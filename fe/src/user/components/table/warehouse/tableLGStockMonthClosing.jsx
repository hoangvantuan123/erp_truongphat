...
function TableLGStockMonthClosing({
  data,
  setSelection,
  selection,
  setShowSearch,
  ...
  const [hiddenColumns, setHiddenColumns] = useState(
    loadFromLocalStorageSheet('H_ERP_COLS_PAGE_STOCK_CLOSING_MONTH_LIST', []),
  )
  ...
  const getData = useCallback(
    ([col, row]) => {
      ...
      if (columnKey === 'IsCloseMaterial' || columnKey === 'IsCloseItem') {
        const booleanValue =
          value === 1 || value === '1'
            ? true
            : value === 0 || value === '0'
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet(
        'H_ERP_COLS_PAGE_STOCK_CLOSING_MONTH_LIST',
        newHidden,
      )
      return newHidden
    })
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('S_ERP_COLS_PAGE_STOCK_CLOSING_MONTH_LIST')
    localStorage.removeItem('H_ERP_COLS_PAGE_STOCK_CLOSING_MONTH_LIST')
  }
...
export default TableLGStockMonthClosing
