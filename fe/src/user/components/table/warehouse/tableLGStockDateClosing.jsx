...
function TableLGStockDateClosing({
  data,
  setSelection,
  selection,
  setShowSearch,
  ...
  const [hiddenColumns, setHiddenColumns] = useState(
    loadFromLocalStorageSheet('H_ERP_COLS_PAGE_STOCK_CLOSING_DATE_LIST', []),
  )
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet(
        'H_ERP_COLS_PAGE_STOCK_CLOSING_DATE_LIST',
        newHidden,
      )
      return newHidden
    })
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('S_ERP_COLS_PAGE_STOCK_CLOSING_DATE_LIST')
    localStorage.removeItem('H_ERP_COLS_PAGE_STOCK_CLOSING_DATE_LIST')
  }
...
export default TableLGStockDateClosing
