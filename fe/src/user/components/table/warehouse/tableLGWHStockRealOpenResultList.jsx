...
function TableLGWHStockRealOpenResultList({
  setSelection,
  selection,
  setShowSearch,
  showSearch,
  ...
  const [hiddenColumns, setHiddenColumns] = useState(
    loadFromLocalStorageSheet(
      'H_ERP_COLS_PAGE_STOCK_REAL_OPEN_RESULT_LIST',
      [],
    ),
  )
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('S_ERP_COLS_PAGE_STOCK_REAL_OPEN_RESULT_LIST')
    localStorage.removeItem('H_ERP_COLS_PAGE_STOCK_REAL_OPEN_RESULT_LIST')
  }
...
export default TableLGWHStockRealOpenResultList
