...
function TableLGEtcInReqItemList({
  data,
  setSelection,
  selection,
  setShowSearch,
  ...
  const [hiddenColumns, setHiddenColumns] = useState(
    loadFromLocalStorageSheet('H_ERP_COLS_PAGE_ETC_IN_REQ_ITEM_LIST', []),
  )
  ...
  const totalRowIndex = data?.findIndex((row) => row?.BizUnitName === 'TOTAL')
  ...
  const handleSort = (columnId, direction) => {
    setGridData((prevData) => {
      ...
      const otherRows = prevData.filter((row) => row.BizUnitName !== 'TOTAL')
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('H_ERP_COLS_PAGE_ETC_IN_REQ_ITEM_LIST', newHidden)
      return newHidden
    })
  }
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet(
        'S_ERP_COLS_PAGE_ETC_IN_REQ_ITEM_LIST',
        uniqueCols,
      )
      return uniqueCols
    })
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('S_ERP_COLS_PAGE_ETC_IN_REQ_ITEM_LIST')
    localStorage.removeItem('H_ERP_COLS_PAGE_ETC_IN_REQ_ITEM_LIST')
  }
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('S_ERP_COLS_PAGE_ETC_IN_REQ_ITEM_LIST', newCols)
        return newCols
      })
      setHiddenColumns((prevHidden) => {
        const newHidden = prevHidden.filter((id) => id !== columnId)
        saveToLocalStorageSheet(
          'H_ERP_COLS_PAGE_ETC_IN_REQ_ITEM_LIST',
          newHidden,
        )
        return newHidden
      })
...
export default TableLGEtcInReqItemList
