...
function TableIqcPurchaseReqList({
  dataUnit,
  setSelection,
  selection,
  setShowSearch,
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('H_ERP_COLS_PAGE_IQC_PURCHASE_PAGE', [])
  })
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('H_ERP_COLS_PAGE_IQC_PURCHASE_PAGE', newHidden)
      return newHidden
    })
  }
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_IQC_PURCHASE_PAGE', uniqueCols)
      return uniqueCols
    })
  }
  // Hàm ẩn cột
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('S_ERP_COLS_PAGE_IQC_PURCHASE_PAGE')
    localStorage.removeItem('H_ERP_COLS_PAGE_IQC_PURCHASE_PAGE')
    setShowMenu(null)
  }
  ...
  const onColumnMoved = useCallback((startIndex, endIndex) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_IQC_PURCHASE_PAGE', updatedCols)
      return updatedCols
    })
  }, [])
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('S_ERP_COLS_PAGE_IQC_PURCHASE_PAGE', newCols)
        return newCols
      })
      setHiddenColumns((prevHidden) => {
  ...
  const formattedData = gridData.map((item) => {
    ...
    cols.forEach((header) => {
      if (item[header.id] !== undefined) {
        if (header.id === 'QCDate' || header.id === 'BLDate') {
...
export default TableIqcPurchaseReqList
