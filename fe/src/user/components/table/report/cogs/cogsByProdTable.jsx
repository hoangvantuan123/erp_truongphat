...
function CogsByProdTable({
    ...
    const [hiddenColumns, setHiddenColumns] = useState(() => {
        return loadFromLocalStorageSheet('cogs_by_prod_h', [])
    })
    ...
    const getData = useCallback(
        ([col, row]) => {
            ...
            const numericColumns = [
                'BegAmt_Mat',
                'BegAmt_Labor', 'BegAmt_Prod', 'BegAmt_Tot',
                'ProdQty', 'InQty', 'TotalAmt',
                'ProdAmt', 'ProdAmtUnit', 'ProdMat',
                'ProdLabor', 'ProdExp', 'InPutCost',
                'InputMat', 'InputLabor', 'InputExp',
                'SubFGoodCost', 'SubFGoodMat', 'SubFGoodLabor',
                'SubFGoodExp', 'ProcMat', 'ProcLabor',
                'ProcExp', 'EndAmt_Mat',
                'EndAmt_Labor', 'EndAmt_Prod', 'EndAmt_Tot',
    ...
    const updateHiddenColumns = (newHiddenColumns) => {
        setHiddenColumns((prevHidden) => {
            ...
            saveToLocalStorageSheet('cogs_by_prod_h', newHidden)
            return newHidden
        })
    }
    ...
    const updateVisibleColumns = (newVisibleColumns) => {
        setCols((prevCols) => {
            ...
            saveToLocalStorageSheet('cogs_by_prod_a', uniqueCols)
            return uniqueCols
        })
    }
    ...
    const handleReset = () => {
        ...
        setHiddenColumns([])
        localStorage.removeItem('cogs_by_prod_a')
        localStorage.removeItem('cogs_by_prod_h')
    }
    ...
    const onColumnMoved = useCallback((startIndex, endIndex) => {
        setCols((prevCols) => {
            ...
            saveToLocalStorageSheet('cogs_by_prod_a', updatedCols)
            return updatedCols
        })
    }, [])
    ...
    const showDrawer = () => {
        ...
        const currentVisibleCols = loadFromLocalStorageSheet('cogs_by_prod_a', []).map(
            (col) => col.id
        )
    ...
    const handleCheckboxChange = (columnId, isChecked) => {
        if (isChecked) {
            ...
            setCols((prevCols) => {
                ...
                saveToLocalStorageSheet('cogs_by_prod_a', newCols)
                return newCols
            })
            setHiddenColumns((prevHidden) => {
...
export default CogsByProdTable
