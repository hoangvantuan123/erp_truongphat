...
function FinancialReportTable({
    ...
    const [hiddenColumns, setHiddenColumns] = useState(() => {
        return loadFromLocalStorageSheet('financial_report_h', [])
    })
    ...
    const getData = useCallback(
        ([col, row]) => {
            ...
            const level = person["FSItemLevel"];
            ...
            // 👉 Format số tiền
            if (
                columnKey === 'ThisTermAmt' ||
                columnKey === 'PrevTermAmt' ||
                columnKey === 'ThisTermItemAmt' ||
                columnKey === 'PrevTermItemAmt'
            ) {
    ...
    const updateHiddenColumns = (newHiddenColumns) => {
        setHiddenColumns((prevHidden) => {
            ...
            saveToLocalStorageSheet('financial_report_h', newHidden)
            return newHidden
        })
    }
    ...
    const updateVisibleColumns = (newVisibleColumns) => {
        setCols((prevCols) => {
            ...
            saveToLocalStorageSheet('financial_report_a', uniqueCols)
            return uniqueCols
        })
    }
    ...
    const handleReset = () => {
        ...
        setHiddenColumns([])
        localStorage.removeItem('financial_report_a')
        localStorage.removeItem('financial_report_h')
    }
    ...
    const onColumnMoved = useCallback((startIndex, endIndex) => {
        setCols((prevCols) => {
            ...
            saveToLocalStorageSheet('financial_report_a', updatedCols)
            return updatedCols
        })
    }, [])
    ...
    const showDrawer = () => {
        ...
        const currentVisibleCols = loadFromLocalStorageSheet('financial_report_a', []).map(
            (col) => col.id
        )
    ...
    const handleCheckboxChange = (columnId, isChecked) => {
        if (isChecked) {
            ...
            setCols((prevCols) => {
                ...
                saveToLocalStorageSheet('financial_report_a', newCols)
                return newCols
            })
            setHiddenColumns((prevHidden) => {
