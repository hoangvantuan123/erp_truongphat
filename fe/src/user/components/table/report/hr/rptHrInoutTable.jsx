...
function RptHrInoutTable({
    ...
    const [hiddenColumns, setHiddenColumns] = useState(() => {
        return loadFromLocalStorageSheet('rpt_hr_inout_1_h', [])
    })
    ...
    const getData = useCallback(
        ([col, row]) => {
            ...
            const numericColumns = [
                'EmpCnt01', 'EmpCnt02', 'EmpCnt03',
                'EmpCnt04', 'EmpCnt05', 'EmpCnt06',
                'EmpCnt07', 'EmpCnt08', 'EmpCnt09', 'EmpCnt10',
                'EmpCnt10',
                'EmpCnt11',
                'EmpCnt12', 
                'EmpCnt00'
    ...
    const updateHiddenColumns = (newHiddenColumns) => {
        setHiddenColumns((prevHidden) => {
            ...
            saveToLocalStorageSheet('rpt_hr_inout_1_h', newHidden)
            return newHidden
        })
    }
    ...
    const updateVisibleColumns = (newVisibleColumns) => {
        setCols((prevCols) => {
            ...
            saveToLocalStorageSheet('rpt_hr_inout_1_a', uniqueCols)
            return uniqueCols
        })
    }
    ...
    const handleReset = () => {
        ...
        setHiddenColumns([])
        localStorage.removeItem('rpt_hr_inout_1_a')
        localStorage.removeItem('rpt_hr_inout_1_h')
    }
    ...
    const onColumnMoved = useCallback((startIndex, endIndex) => {
        setCols((prevCols) => {
            ...
            saveToLocalStorageSheet('rpt_hr_inout_1_a', updatedCols)
            return updatedCols
        })
    }, [])
    ...
    const showDrawer = () => {
        ...
        const currentVisibleCols = loadFromLocalStorageSheet('rpt_hr_inout_1_a', []).map(
            (col) => col.id
        )
    ...
    const handleCheckboxChange = (columnId, isChecked) => {
        if (isChecked) {
            ...
            setCols((prevCols) => {
                ...
                saveToLocalStorageSheet('rpt_hr_inout_1_a', newCols)
                return newCols
            })
            setHiddenColumns((prevHidden) => {
...
export default RptHrInoutTable
