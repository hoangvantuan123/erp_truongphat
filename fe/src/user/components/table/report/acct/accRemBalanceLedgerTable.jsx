...
function AccRemBalanceLedgerTable({
    setSelection,
    selection,
    setShowSearch,
    showSearch,
    ...
    const [hiddenColumns, setHiddenColumns] = useState(() => {
        return loadFromLocalStorageSheet('acct_rem_balance_ledger_h', [])
    })
    ...
    const getData = useCallback(
        ([col, row]) => {
            ...
            const numericColumns = [
                'DrAmt', 'CrAmt', 'ForwardDrAmt', 'RemainAmt'
            ];
    ...
    const updateHiddenColumns = (newHiddenColumns) => {
        setHiddenColumns((prevHidden) => {
            ...
            saveToLocalStorageSheet('acct_rem_balance_ledger_h', newHidden)
            return newHidden
        })
    }
    ...
    const updateVisibleColumns = (newVisibleColumns) => {
        setCols((prevCols) => {
            ...
            saveToLocalStorageSheet('acct_rem_balance_ledger_a', uniqueCols)
            return uniqueCols
        })
    }
    ...
    const handleReset = () => {
        ...
        setHiddenColumns([])
        localStorage.removeItem('acct_rem_balance_ledger_a')
        localStorage.removeItem('acct_rem_balance_ledger_h')
    }
    ...
    const onColumnMoved = useCallback((startIndex, endIndex) => {
        setCols((prevCols) => {
            ...
            saveToLocalStorageSheet('acct_rem_balance_ledger_a', updatedCols)
            return updatedCols
        })
    }, [])
    ...
    const showDrawer = () => {
        ...
        const currentVisibleCols = loadFromLocalStorageSheet('acct_rem_balance_ledger_a', []).map(
            (col) => col.id
        )
    ...
    const handleCheckboxChange = (columnId, isChecked) => {
        if (isChecked) {
            ...
            setCols((prevCols) => {
                ...
                saveToLocalStorageSheet('acct_rem_balance_ledger_a', newCols)
                return newCols
            })
            setHiddenColumns((prevHidden) => {
...
export default AccRemBalanceLedgerTable
