...
function TableOqcFinResultList({
  dataUnit,
  setSelection,
  selection,
  setShowSearch,
  ...
  const [keybindings, setKeybindings] = useState({
    ...
    const getData = useCallback(
      ...
      if (
        ...
        columnKey === 'QCQty' ||
        columnKey === 'StdQCQty' ||
        columnKey === 'StdPassedQty' ||
        columnKey === 'StdRejectQty' ||
        columnKey === 'RealSampleQty' ||
        columnKey === 'StdRealSampleQty' ||
        columnKey === 'BadSampleQty' ||
        columnKey === 'StdBadSampleQty' ||
        columnKey === 'RejectQty' ||
        columnKey === 'QCQty'
      ) {
        return {
...
export default TableOqcFinResultList
