...
function TableQcItemClassQcLeft({
  dataQcUmTitleName,
  dataTestMethod,
  dataSamplingStd,
  dataAQLLevelName,
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('H_ERP_COLS_PAGE_QA_ITEM_CLASS_QC_LEFT', [])
  })
        ...
        if (newValue.kind === GridCellKind.Custom) {
          setGridData((prev) => {
            ...
            if (selectedName || selectedName !== undefined) {
              ...
              product['UMQCTitleName'] = selectedName.MinorName
              product['UMQCTitleSeq'] = selectedName.Value
            } else {
              product[cols[col].id] = ''
      ...
      if (key === 'TestMethodName') {
        if (newValue.kind === GridCellKind.Custom) {
          setGridData((prev) => {
            ...
            if (selectedName || selectedName !== undefined) {
              product[cols[col].id] = selectedName.MinorName
              product['TestMethodName'] = selectedName.MinorName
              product['TestMethod'] = selectedName.Value
            } else {
              product[cols[col].id] = ''
              product['TestMethodName'] = ''
              product['TestMethod'] = ''
            }
      ...
      if (key === 'SamplingStdName') {
        if (newValue.kind === GridCellKind.Custom) {
          setGridData((prev) => {
            ...
            const checkCopyData = newValue.copyData
            if (!selectedName) {
              selectedName = dataSamplingStd.find(
                (item) => item.MinorName === checkCopyData,
              )
            }
            ...
            if (selectedName || selectedName !== undefined) {
              product[cols[col].id] = selectedName.MinorName
              product['SamplingStdName'] = selectedName.MinorName
              product['SamplingStd'] = selectedName.Value
            } else {
              product[cols[col].id] = ''
              product['SamplingStdName'] = ''
              product['SamplingStd'] = ''
            }
      ...
      if (key === 'AQLLevelName') {
        if (newValue.kind === GridCellKind.Custom) {
          setGridData((prev) => {
            ...
            if (selectedName || selectedName !== undefined) {
              product[cols[col].id] = selectedName.MinorName
              product['AQLLevelName'] = selectedName.MinorName
              product['AQLLevel'] = selectedName.Value
            } else {
              product[cols[col].id] = ''
              product['AQLLevelName'] = ''
              product['AQLLevel'] = ''
            }
      ...
      if (key === 'AQLStrictName') {
        if (newValue.kind === GridCellKind.Custom) {
          setGridData((prev) => {
            ...
            if (selectedName || selectedName !== undefined) {
              product[cols[col].id] = selectedName.MinorName
              product['AQLStrictName'] = selectedName.MinorName
              product['AQLStrict'] = selectedName.Value
            } else {
              product[cols[col].id] = ''
              product['AQLStrictName'] = ''
              product['AQLStrict'] = ''
            }
      ...
      if (key === 'AQLPointName') {
        if (newValue.kind === GridCellKind.Custom) {
          setGridData((prev) => {
            ...
            if (selectedName || selectedName !== undefined) {
              product[cols[col].id] = selectedName.MinorName
              product['AQLPointName'] = selectedName.MinorName
              product['AQLPoint'] = selectedName.Value
            } else {
              product[cols[col].id] = ''
              product['AQLPointName'] = ''
              product['AQLPoint'] = ''
            }
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('H_ERP_COLS_PAGE_QA_ITEM_CLASS_QC_LEFT', newHidden)
      return newHidden
    })
  }
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_QA_ITEM_CLASS_QC_LEFT', uniqueCols)
      return uniqueCols
    })
  }
  // Hàm ẩn cột
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('S_ERP_COLS_PAGE_QA_ITEM_CLASS_QC_LEFT')
    localStorage.removeItem('H_ERP_COLS_PAGE_QA_ITEM_CLASS_QC_LEFT')
    setShowMenu(null)
  }
  ...
  const onColumnMoved = useCallback((startIndex, endIndex) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_QA_ITEM_CLASS_QC_LEFT', updatedCols)
      return updatedCols
    })
  }, [])
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('S_ERP_COLS_PAGE_QA_ITEM_CLASS_QC_LEFT', newCols)
        return newCols
      })
      setHiddenColumns((prevHidden) => {
...
export default TableQcItemClassQcLeft
