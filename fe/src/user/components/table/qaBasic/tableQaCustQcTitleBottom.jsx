...
function TableQaCustQcTitleBottom({
  dataQcUmTitleName,
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('H_ERP_COLS_PAGE_QC_CUST_TITLE_BOTTOM', [])
  })
      ...
      if (key === 'UMQCTitleName') {
        if (newValue.kind === GridCellKind.Custom) {
          setGridData((prev) => {
            ...
            console.log('checkCopyData', checkCopyData)
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('H_ERP_COLS_PAGE_QC_CUST_TITLE_BOTTOM', newHidden)
      return newHidden
    })
  }
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_QC_CUST_TITLE_BOTTOM', uniqueCols)
      return uniqueCols
    })
  }
  // Hàm ẩn cột
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('S_ERP_COLS_PAGE_QC_CUST_TITLE_BOTTOM')
    localStorage.removeItem('H_ERP_COLS_PAGE_QC_CUST_TITLE_BOTTOM')
    setShowMenu(null)
  }
  ...
  const onColumnMoved = useCallback((startIndex, endIndex) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_QC_CUST_TITLE_BOTTOM', updatedCols)
      return updatedCols
    })
  }, [])
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('S_ERP_COLS_PAGE_QC_CUST_TITLE_BOTTOM', newCols)
        return newCols
      })
      setHiddenColumns((prevHidden) => {
...
export default TableQaCustQcTitleBottom
