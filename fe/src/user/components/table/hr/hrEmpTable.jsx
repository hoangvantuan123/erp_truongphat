...
function HrEmpTable({
    ...
    const columnNames = ['UMEmpTypeName', 'EmpName']
    ...
    const onCellEdited = useCallback(
        async (cell, newValue) => {
                ...
                if (newValue.kind === GridCellKind.Custom) {
                    setGridData((prev) => {
                        ...
                        if (selectedName) {
                            ...
                            product['UMEmpType'] = selectedName.Value
            ...
            if (
                key === 'UMEmpType' || key === 'EmpSeq' || key === 'EmpName'
            ) {
                return;
            }
