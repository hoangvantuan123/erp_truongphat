...
function TableImpOrderItemList({
  setSelection,
  selection,
  setShowSearch,
  showSearch,
  ...
  const [hiddenColumns, setHiddenColumns] = useState(
    loadFromLocalStorageSheet('H_ERP_COLS_PAGE_IMP_ORDER_ITEM_LIST', []),
  )
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('H_ERP_COLS_PAGE_IMP_ORDER_ITEM_LIST', newHidden)
      return newHidden
    })
  }
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_IMP_ORDER_ITEM_LIST', uniqueCols)
      return uniqueCols
    })
  }
    ...
    if (cols.length > 1) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet(
          'S_ERP_COLS_PAGE_IMP_ORDER_ITEM_LIST',
          uniqueCols,
        )
        return uniqueCols
      })
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('S_ERP_COLS_PAGE_IMP_ORDER_ITEM_LIST')
    localStorage.removeItem('H_ERP_COLS_PAGE_IMP_ORDER_ITEM_LIST')
  }
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('S_ERP_COLS_PAGE_IMP_ORDER_ITEM_LIST', newCols)
        return newCols
      })
      setHiddenColumns((prevHidden) => {
        const newHidden = prevHidden.filter((id) => id !== columnId)
        saveToLocalStorageSheet(
          'H_ERP_COLS_PAGE_IMP_ORDER_ITEM_LIST',
          newHidden,
        )
        return newHidden
      })
...
export default TableImpOrderItemList
