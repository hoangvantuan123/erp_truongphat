...
function TableImpDeliveryList({
  ...
  const [hiddenColumns, setHiddenColumns] = useState(
    loadFromLocalStorageSheet('H_ERP_COLS_PAGE_IMP_DELIVERY_LIST', []),
  )
  ...
  const getData = useCallback(
    ([col, row]) => {
      ...
      if (
        columnKey === 'IsExpense' ||
        columnKey === 'IsCostCalc' ||
        columnKey === 'IsCostSlip' ||
        columnKey === 'IsPJT' ||
        columnKey === 'IsClaim'
      ) {
        const booleanValue =
      ...
      if (columnKey === 'DelvDate' || columnKey === 'AcceptDate') {
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('H_ERP_COLS_PAGE_IMP_DELIVERY_LIST', newHidden)
      return newHidden
    })
  }
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_IMP_DELIVERY_LIST', uniqueCols)
      return uniqueCols
    })
  }
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('S_ERP_COLS_PAGE_IMP_DELIVERY_LIST')
    localStorage.removeItem('H_ERP_COLS_PAGE_IMP_DELIVERY_LIST')
  }
  ...
  const onColumnMoved = useCallback((startIndex, endIndex) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_IMP_DELIVERY_LIST', updatedCols)
      return updatedCols
    })
  }, [])
  ...
  const showDrawer = () => {
    ...
    const currentVisibleCols = loadFromLocalStorageSheet(
      'S_ERP_COLS_PAGE_IMP_DELIVERY_LIST',
      [],
    ).map((col) => col.id)
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('S_ERP_COLS_PAGE_IMP_DELIVERY_LIST', newCols)
        return newCols
      })
      setHiddenColumns((prevHidden) => {
...
export default TableImpDeliveryList
