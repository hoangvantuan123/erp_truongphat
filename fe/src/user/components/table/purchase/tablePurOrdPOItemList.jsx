...
function TablePurOrdPOItemList({
  setSelection,
  selection,
  setShowSearch,
  showSearch,
  ...
  const [hiddenColumns, setHiddenColumns] = useState(
    loadFromLocalStorageSheet('H_ERP_COLS_PAGE_ORD_PO_ITEM_LIST', []),
  )
  ...
  const getData = useCallback(
    ([col, row]) => {
      ...
      if (
        ...
        columnKey === 'DelvQty' ||
        columnKey === 'RemainQty' ||
        columnKey === 'DelvCurAmt' ||
        columnKey === 'DelvDomAmt' ||
        columnKey === 'DelvInQty' ||
        columnKey === 'DelvInCurAmt' ||
        columnKey === 'DelvInDomAmt' ||
        columnKey === 'StopQty' ||
        columnKey === 'BasicAmt'
      ) {
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('H_ERP_COLS_PAGE_ORD_PO_ITEM_LIST', newHidden)
      return newHidden
    })
  }
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_ORD_PO_ITEM_LIST', uniqueCols)
      return uniqueCols
    })
  }
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('S_ERP_COLS_PAGE_ORD_PO_ITEM_LIST')
    localStorage.removeItem('H_ERP_COLS_PAGE_ORD_PO_ITEM_LIST')
  }
  ...
  const onColumnMoved = useCallback((startIndex, endIndex) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_ORD_PO_ITEM_LIST', updatedCols)
      return updatedCols
    })
  }, [])
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('S_ERP_COLS_PAGE_ORD_PO_ITEM_LIST', newCols)
        return newCols
      })
      setHiddenColumns((prevHidden) => {
...
export default TablePurOrdPOItemList
