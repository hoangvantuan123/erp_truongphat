...
const CodeHelpEduClass = ({
  ...
  const handleSearch = useCallback(
    (e) => {
      ...
      const propertiesToSearch = ['EduClassSeq', 'EduClassName']
  ...
  const handleCellClick = ([col, row]) => {
    ...
    if (data[row]) {
      const ItemName = data[row].EduClassName

      setMinorName(ItemName)
      setValue(data[row].EduClassSeq)
...
export default CodeHelpEduClass
