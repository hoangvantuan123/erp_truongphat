...
function CodeHelpPart({
  ...
  const handleCellClick = ([col, row]) => {
    ...
    if (dataClick[row]) {
      ...
      setUMJoName(selectedUserName)
      setUMJoSeq(dataClick[row].Value)
  ...
  const onKeyDown = (e) => {
    ...
    if (e.key === 'Enter' && filteredData.length > 0) {
      ...
      setUMJoName(selectedUser?.MinorName)
      setUMJoSeq(selectedUser?.Value)
