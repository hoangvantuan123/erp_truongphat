...
const CodeHelpEduCourse = ({
  ...
  const handleSearch = useCallback(
    (e) => {
      ...
      const propertiesToSearch = ['EduCourseName']
  ...
  const handleCellClick = ([col, row]) => {
    const data = minorName.trim() === '' ? helpData : filteredData
    if (data[row]) {
      const ItemName = data[row].EduCourseName

      setMinorName(ItemName)
      setValue(data[row].EduCourseSeq)
...
export default CodeHelpEduCourse;
