...
const CodeHelpEduType = ({
  ...
  const handleSearch = useCallback(
    (e) => {
      ...
      const propertiesToSearch = ['EduTypeSeq', 'EduTypeName']
  ...
  const handleCellClick = ([col, row]) => {
    ...
    if (data[row]) {
      const ItemName = data[row].EduTypeName

      setMinorName(ItemName)
      setValue(data[row].EduTypeSeq)
...
export default CodeHelpEduType
