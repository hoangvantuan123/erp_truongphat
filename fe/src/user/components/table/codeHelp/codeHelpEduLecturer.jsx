...
const CodeHelpEduLecturer = ({
  ...
  const handleSearch = useCallback(
    (e) => {
      ...
      const propertiesToSearch = ['LecturerName']
  ...
  const handleCellClick = ([col, row]) => {
    ...
    if (data[row]) {
      const ItemName = data[row].LecturerName

      setMinorName(ItemName)
      setValue(data[row].LecturerSeq)
...
export default CodeHelpEduLecturer;
