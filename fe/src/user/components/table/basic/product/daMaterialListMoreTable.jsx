...
import DaMaterialListMoreQuery from '../../../query/basic/product/daMaterialListMoreQuery'

function DaMaterialListMoreTable({
    setSelection,
    selection,
    setShowSearch,
    showSearch,
        ...
        <div className="w-full gap-1 h-full flex items-center justify-center">
            <div className="w-full h-full flex flex-col  bg-white  overflow-hidden ">
                ...
                <DaMaterialListMoreQuery
                    ...
                    setSpec={setSpec}
                />
                <div className='flex items-center px-2 p-1 justify-between border-b text-[10px] border-t text-black  font-medium uppercase'>
...
export default DaMaterialListMoreTable
