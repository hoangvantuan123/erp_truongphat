...
function TableDefine({
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('define_ah', [])
  })
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('define_ah', newHidden)
      return newHidden
    })
  }
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('define_a', uniqueCols)
      return uniqueCols
    })
  }
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([])
    localStorage.removeItem('define_a')
    localStorage.removeItem('define_ah')
    setShowMenu(null)
  }
  ...
  const onColumnMoved = useCallback((startIndex, endIndex) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('define_a', updatedCols)
      return updatedCols
    })
  }, [])
  ...
  const showDrawer = () => {
    const invisibleCols = defaultCols
      ...
      .map((col) => col.id)
    const currentVisibleCols = loadFromLocalStorageSheet('define_a', []).map(
      (col) => col.id,
    )
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('define_a', newCols)
        return newCols
      })
      setHiddenColumns((prevHidden) => {
