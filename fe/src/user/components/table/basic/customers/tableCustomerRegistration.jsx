...
function TableCustomerRegistration({
  setSelection,
  selection,
  setShowSearch,
  showSearch,
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('page_customrer_reg_h', [])
  })
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('page_customrer_reg_h', newHidden)
      return newHidden
    })
  }
  ...
  const handleReset = () => {
    ...
    localStorage.removeItem('page_customrer_reg_h')
  }
...
export default TableCustomerRegistration
