...
function Equip5Table({
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('emp_04_h', [])
  })
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('emp_04_h', newHidden)
      return newHidden
    })
  }
  ...
  const handleReset = () => {
    ...
    localStorage.removeItem('emp_04_h')
  }
