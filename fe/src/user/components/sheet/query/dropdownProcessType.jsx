...
const DropdownProcessType = ({ helpData, setSearchText, searchText, setItemText, setDataSearch, setDataSheetSearch, setDropdownVisible, dropdownVisible }) => {
...
export default DropdownProcessType;