...
const DropdownItemL = ({
    ...
    const columnDefs = useMemo(() => [
        { title: t('2115'), id: 'MinorName', kind: 'Text', readonly: true, width: 300 },
        { title: t('Value'), id: 'Value', kind: 'Text', readonly: true, width: 200 },
    ], [t]);
    ...
    const handleCellClick = ([, row]) => {
        ...
        setSearchText(data.MinorName || '');
        setItemText(data.MinorName || '');
        setDataSearch(data);
        setDropdownVisible(false);
    };
