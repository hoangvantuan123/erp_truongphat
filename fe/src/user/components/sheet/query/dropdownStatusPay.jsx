...
const DropdownStatusPay = ({ helpData, setSearchText, searchText, setItemText, setDataSearch, setDropdownVisible, dropdownVisible }) => {
...
export default DropdownStatusPay;