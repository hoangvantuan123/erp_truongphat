...
const DropdownItem = ({
    ...
    const cols = useMemo(() => [
        { title: t('1954'), id: 'ItemName', kind: 'Text', readonly: true, width: 300 },
        { title: t('16833'), id: 'ItemNo', kind: 'Text', readonly: true, width: 200 },
        { title: t('551'), id: 'Spec', kind: 'Text', readonly: true, width: 200 },
        { title: t('1954'), id: 'AssetName', kind: 'Text', readonly: true, width: 200 },
        { title: t('3122'), id: 'ItemClassLName', kind: 'Text', readonly: true, width: 200 },
        { title: t('3262'), id: 'ItemClassMName', kind: 'Text', readonly: true, width: 200 },
        { title: t('15151'), id: 'ItemClassName', kind: 'Text', readonly: true, width: 200 },
        { title: t('602'), id: 'UnitName', kind: 'Text', readonly: true, width: 200 },
    ], [t]);
