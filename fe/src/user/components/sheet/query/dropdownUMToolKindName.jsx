...
const DropdownUMToolKindName = ({
  ...
  const handleCellClick = ([col, row]) => {
    console.log('UmToolKindName', UmToolKindName)
    const data = UmToolKindName.trim() === '' ? helpData : filteredData
    if (data[row]) {
      const ItemName = data[row].MinorName

      setUmToolKindName(ItemName)
      setUmToolKind(data[row].Value)
...
export default DropdownUMToolKindName
