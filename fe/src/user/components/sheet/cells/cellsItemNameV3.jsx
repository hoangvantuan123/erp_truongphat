...
const Editor = (p) => {
    ...
    const filteredData = allowedValues.filter((item) => {
        ...
        const propertiesToSearch = ['ItemName', 'ItemNo']
...
export const CellsItemNameV3 = {
    kind: GridCellKind.Custom,
    isMatch: (c) => c.data.kind === 'cell-item-name-v3',
    draw: (args, cell) => {
