  ...
  return (
    <div className="w-full ">
      ...
      <DataEditor
        ...
        columns={[
          { title: 'Mã kiểm kết quả', width: 150 },
          { title: 'Kết quả', width: 240 },
        ...
        getCellContent={([col, row]) => {
          ...
          if (col === 0) {
            ...
            cellData = filteredData[row].MinorName || ''
          }
...
export const CellsSMTestResultName = {
  kind: GridCellKind.Custom,
  isMatch: (c) => c.data.kind === 'sm-test-result-name-cell',
  draw: (args, cell) => {
