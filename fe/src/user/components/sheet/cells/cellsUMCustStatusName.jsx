...
const Editor = (p) => {
  ...
  const filteredData = allowedValues.filter((item) => {
    ...
    const propertiesToSearch = ['SMCustStatus', 'SMCustStatusName']
...
export const CellsCustStatus = {
  kind: GridCellKind.Custom,
  isMatch: (c) => c.data.kind === "cust-status-cell",
  draw: (args, cell) => {
  ...
  onPaste: (v, d) => {
    ...
    const matchedValues = d.allowedValues.filter((item) =>
      ['SMCustStatusName', 'SMCustStatus'].some(
