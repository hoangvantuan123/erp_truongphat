...
export const Editor = (p) => {
  ...
  const debounceCallGetCodeHelp = useMemo(() =>
    debounce(async (key) => {
      ...
      try {
        const result = await GetCodeHelp(18084, key, "1", "1", "", "", "2", 1, 0, "", 0, 0, 0, controller.signal);
...
export const Cells18084V2 = {
  kind: GridCellKind.Custom,
  isMatch: (c) => c.data.kind === 'cell-18084-v2',
  draw: (args, cell) => {
