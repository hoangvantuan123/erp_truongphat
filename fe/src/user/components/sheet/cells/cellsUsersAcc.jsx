...
export const Editor = (p) => {
    ...
    const filteredData = useMemo(() => {
        ...
        const propertiesToSearch = ["EmpID", "UserName"];
    ...
    const finalFilteredData = useMemo(() => {
        ...
        const newData = extraData.filter((item) => !existingItemSeqs.has(item.EmpID));
        setCacheData((prev) => {
...
export const CellsUserAcc = {
    kind: GridCellKind.Custom,
    isMatch: (c) => c.data.kind === 'help-cell-users-acc',
    draw: (args, cell) => {
