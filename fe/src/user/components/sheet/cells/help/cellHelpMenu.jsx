...
import { SearchOutlined, TableOutlined, LoadingOutlined, ControlOutlined, RollbackOutlined } from '@ant-design/icons'
...
export const Editor = (p) => {
    ...
    const defaultCols = useMemo(() => [
        { title: 'Type', id: 'Type', kind: 'Text', readonly: true, width: 200, hasMenu: true, visible: true },
        ...
        { title: 'Link', id: 'Link', kind: 'Text', readonly: true, width: 370, hasMenu: true, visible: true },
    ], []);
    ...
    const debounceCallApi = useMemo(() => debounce((searchText) => {
        ...
        const propertiesToSearch = ["Key", "Label", "Type"];
...
export const CellsHelpMenu = {
    kind: GridCellKind.Custom,
    isMatch: (c) => c.data.kind === 'cell-menu',
    draw: (args, cell) => {
