...
export const Editor = (p) => {
    ...
    const defaultCols = useMemo(() => [
        { title: 'UserId', id: 'UserId', kind: 'Text', readonly: true, width: 200, hasMenu: true, visible: true },
        { title: 'UserName', id: 'UserName', kind: 'Text', readonly: true, width: 300, hasMenu: true, visible: true },
    ], []);
    ...
    const debounceCallApi = useMemo(() => debounce((searchText) => {
        ...
        const propertiesToSearch = ["UserId", "EmpName"];
...
export const CellsHelpUsers = {
    kind: GridCellKind.Custom,
    isMatch: (c) => c.data.kind === 'cell-users',
    draw: (args, cell) => {
