...
const Editor = (p) => {
  ...
  const [cols, setCols] = useState([
    { title: t('Name'), width: 250 },
    { title: t('Id'), width: 250 },
    ...
    <div ref={dropdownRef} className="">
      ...
      <DataEditor
        ...
        getCellContent={([col, row]) => {
          ...
          switch (col) {
            case 0:
              cellData = filteredData[row].Name || ''
              break
            default:
              cellData = filteredData[row].Id || ''
              break
          }
...
export const CellsGroupName = {
  kind: GridCellKind.Custom,
  isMatch: (c) => c.data.kind ==='group-name-help-cell',
  draw: (args, cell) => {
