...
export const Editor = (p) => {
    ...
    const debounceCallGetCodeHelp = useMemo(() =>
        debounce(async (key) => {
            ...
            try {
                const result = await GetCodeHelpComboVer2('', 6, 20021, 1, key, '','','','', controller.signal);
    ...
    const filteredData = useMemo(() => {
        ...
        const propertiesToSearch = ["EduTypeName", "EduTypeSeq"];
...
export const CellsEduType = {
    kind: GridCellKind.Custom,
    isMatch: (c) => c.data.kind === 'cells-edu-type',
    draw: (args, cell) => {
