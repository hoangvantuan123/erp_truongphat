...
const Editor = (p) => {
  ...
  const defaultCols = useMemo(
    () => [
      { title: 'Giá trị', id: 'MinorName', kind: 'Text', readonly: true, width: 200 },
      { title: 'Mã giá trị', id: 'Value', kind: 'Text', readonly: true, width: 200 },
...
export const CellSMHolidayType = {
  kind: GridCellKind.Custom,
  isMatch: (c) => c.data.kind === 'cell-holiday-type',
  draw: (args, cell) => {
