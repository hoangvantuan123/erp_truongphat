...
const Editor = (p) => {
  ...
  const defaultCols = useMemo(
    () => [
      { title: 'Tên hạng mục', id: 'ItemClassName', kind: 'Text', readonly: true, width: 250 },
      { title: 'Tên hạng mục cấp L', id: 'ItemClassLName', kind: 'Text', readonly: true, width: 250 },
      { title: 'Tên hạng mục cấp M', id: 'ItemClassMName', kind: 'Text', readonly: true, width: 250 },
    ],
    []
  );
...
export const CellsItemClassS = {
  kind: GridCellKind.Custom,
  isMatch: (c) => c.data.kind === 'cell-item-class-s',
  draw: (args, cell) => {
