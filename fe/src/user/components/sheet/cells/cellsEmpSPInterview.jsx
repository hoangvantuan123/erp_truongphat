...
const Editor = (p) => {
    ...
    const filteredData = allowedValues.filter((item) => {
        ...
        const propertiesToSearch = ['EmpName', 'EmpID', 'SMSexName', 'InterviewDate']
...
export const CellsEmpSPInterview = {
    kind: GridCellKind.Custom,
    isMatch: (c) => c.data.kind === 'cell-emp-interview',
    draw: (args, cell) => {
    ...
    onPaste: (v, d) => {
        ...
        const matchedValues = d.allowedValues.filter((item) =>
            ['EmpName', 'EmpID', 'SMSexName', 'InterviewDate'].some((attr) => {
                const value = item[attr]
