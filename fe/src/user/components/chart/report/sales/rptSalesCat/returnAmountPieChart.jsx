...
const ReturnAmountPieChart = ({ isDarkMode = false, dataChart, SMTermsKind }) => {
    ...
    const chartData = useMemo(() => {
        ...
        return (dataChart || [])
            .filter(item => {
                ...
                const value = Number(
                    SMTermsKind === 1077002 ? item.YearRtnAmt : item.ThisRtnAmt
                );
...
export default ReturnAmountPieChart;
