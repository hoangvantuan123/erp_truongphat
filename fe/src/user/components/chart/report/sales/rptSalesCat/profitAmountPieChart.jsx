...
const ProfitAmountPieChart = ({ isDarkMode = false, dataChart, SMTermsKind }) => {
    ...
    const chartData = useMemo(() => {
        ...
        return (dataChart || [])
            .filter(item => {
                ...
                const value = Number(
                    SMTermsKind === 1077002 ? item.YearBenefitAmt : item.ThisBenefitAmt
                );
    ...
    const handleDownload = () => {
        ...
        link.href = img;
        link.download = 'sales-value-pie-chart.png';
        link.click();
    };
                ...
                <div className="relative flex gap-2 items-center">
                    ...
                    {showLegendPopup && (
                        <div className="absolute right-0 top-full mt-2 z-50 bg-white dark:bg-gray-800 dark:text-white shadow-lg border rounded w-64 max-h-60 overflow-auto p-2 text-sm">
                            <div className="font-semibold mb-2">Danh sách giá trị</div>
...
export default ProfitAmountPieChart;
