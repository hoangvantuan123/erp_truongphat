...
export default function LGEtcInItemListQuery({
  fromDate,
  setFromDate,
  setToDate,
  toDate,
  ...
  const handleChangeStockType = (value) => {
    setStockType(value)
  }
    ...
    <div className="flex items-center gap-2">
      ...
      >
        <Row className="gap-4 flex items-center mb-4 ">
          ...
          <Col>
            <Form.Item
              label={<span className="uppercase text-[10px]">{t('4575')}</span>}
              className="mb-2"
              style={{ marginBottom: 0 }}
              labelCol={{ style: { marginBottom: 2, padding: 0 } }}
              wrapperCol={{ style: { padding: 0 } }}
          ...
          <Col>
            ...
            >
              <Select
                ...
                options={[
                  { value: '40', label: 'Hàng hóa thành phẩm' },
                  { value: '41', label: 'Nguyên vật liệu' },
                ]}
              />
            </Form.Item>
          </Col>
          ...
          <Col>
            ...
            >
              <Select
                ...
                value={stockType === '0' ? undefined : stockType}
                onChange={handleChangeStockType}
                options={dataStockType?.map((item) => ({
