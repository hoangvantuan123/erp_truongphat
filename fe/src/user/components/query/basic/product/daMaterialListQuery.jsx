        ...
        <ConfigProvider locale={getAntdLocale()}>
            <div className=" container border-r">
                <Descriptions
                    ...
                    column={3}
                >
                    <Descriptions.Item style={{ padding: 0, }} label={<span className="uppercase text-[9px]  text-red-500    p-2 font-bold ">Ngày đăng ký</span>}>
                    ...
                    <Descriptions.Item span={2} style={{ padding: 0 }} label={<span className="uppercase text-[9px]  p-2  font-bold ">Phân loại danh mục hàng</span>}>
                        <AutoComplete
                            options={[
                                { value: '', label: 'All' },
                                ...helpData03.map(opt => ({
                    ...
                    <Descriptions.Item style={{ padding: 0 }} label={<span className="uppercase text-[9px]  p-2  font-bold ">Phân loại lớn hạng mục SP</span>}>
                        <Input
                            placeholder=""
                            value={searchText3}
                    ...
                    <Descriptions.Item style={{ padding: 0 }} label={<span className="uppercase text-[9px]  p-2  font-bold ">Phân loại trung bình</span>}>
                        <Input
                            placeholder=""
                            value={searchText4}
                    ...
                    <Descriptions.Item style={{ padding: 0 }} label={<span className="uppercase text-[9px]  p-2  font-bold ">Phân loại nhỏ danh mục SP</span>}>
                        <Input
                            placeholder=""
                            value={searchText5}
                    ...
                    <Descriptions.Item span={2} style={{ padding: 0 }} label={<span className="uppercase text-[9px]  p-2  font-bold ">HỌ TÊN NHÂN VIÊN</span>}>
                        <Input
                            size="small"
                            className="w-full p-1 bg-[#ebf1ffa6] border-t cursor-pointer rounded-none"
                            variant="borderless"
