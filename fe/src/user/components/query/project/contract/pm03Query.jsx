...
import DropdownStatusPay from '../../../sheet/query/dropdownStatusPay'
import 'dayjs/locale/vi'
import viVN from 'antd/lib/locale/vi_VN';
import koKR from 'antd/lib/locale/ko_KR';
dayjs.locale('vi')

export default function PM03Query({
    setFormDate,
    formDate,
    toDate,
    setToDate,
        ...
        <ConfigProvider locale={getAntdLocale()}>
            <div className=" container border-r">
                ...
                >
                    ...
                    <Descriptions.Item style={{ padding: 0 }} label={<span className="uppercase text-[9px]     p-1 font-bold">Trạng thái thanh toán</span>}>
                        <Input
                            placeholder=""
                            value={searchText6}
                        ...
                        {dropdownVisible4 && (
                            <DropdownStatusPay
                                helpData={helpData06}
                                setSearchText={setSearchText6}
                                setItemText={setItemText6}
                                setDataSearch={setDataSearch6}
                                setDropdownVisible={setDropdownVisible4}
                                dropdownVisible={dropdownVisible4}
                                searchText={searchText6}
                                setDataSheetSearch={setDataSheetSearch6}
