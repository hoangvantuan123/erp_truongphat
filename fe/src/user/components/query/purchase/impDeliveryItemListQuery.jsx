...
export default function ImpDeliveryItemListQuery({
  fromDate,
  setFromDate,
  setToDate,
  toDate,
  ...
  }, [dataDeptName, dataUserName, dataCustName])
      ...
      >
        <Row className="gap-4 flex items-center mb-4">
          ...
          <Col>
            <Form.Item
              label={
                <span className="uppercase text-[10px]">{t('15336')}</span>
              }
              className="mb-2"
              style={{ marginBottom: 0 }}
              labelCol={{ style: { marginBottom: 2, padding: 0 } }}
            ...
            >
              <Input
                value={delvNo}
                onChange={(e) => setDelvNo(e.target.value)}
                size="middle"
                style={{
                  width: 190,
                }}
          ...
          <Col>
            <Form.Item
              label={
                <span className="uppercase text-[10px]">{t('Số hóa đơn')}</span>
              }
              className="mb-2"
              style={{ marginBottom: 0 }}
              labelCol={{ style: { marginBottom: 2, padding: 0 } }}
          ...
          <Col>
            ...
            >
              <Select
                ...
                allowClear
                showSearch
                placeholder="Chọn phân loại nhập khẩu"
                filterOption={(input, option) =>
                  (option?.label ?? '')
                    .toLowerCase()
                    .includes(input.toLowerCase())
