...
export default function PurDelvQuery({
  fromDate,
  setFromDate,
    ...
    <div className="flex items-center gap-2">
      ...
      >
        <Row className="gap-4 flex items-center mb-4 ">
          ...
          <Col>
            <Form.Item
              label={<span className="uppercase text-[10px]">{t('684')}</span>}
              className="mb-2"
              style={{ marginBottom: 0 }}
              labelCol={{ style: { marginBottom: 2, padding: 0 } }}
              wrapperCol={{ style: { padding: 0 } }}
          ...
          <Col>
            <Form.Item
              label={
                <span className="uppercase text-[10px]">{t('29828')}</span>
              }
              className="mb-2"
              style={{ marginBottom: 0 }}
              labelCol={{ style: { marginBottom: 2, padding: 0 } }}
            ...
            >
              <TextArea
                value={delvMngNo}
                onChange={(e) => setDelvMngNo(e.target.value)}
                size="middle"
                autoSize={{
                  minRows: 1,
                  maxRows: 1,
