...
export default function PurOrderApprovalReqItemListQuery({
  fromDate,
  setFromDate,
  setToDate,
  toDate,
      ...
      >
        <Row className="gap-4 flex items-center mb-4">
          ...
          <Col>
            <Form.Item
              label={
                <span className="uppercase text-[10px]">{t('Số giấy tờ')}</span>
              }
              className="mb-2"
              style={{ marginBottom: 0 }}
              labelCol={{ style: { marginBottom: 2, padding: 0 } }}
          ...
          <Col>
            ...
            >
              <Select
                ...
                allowClear
                showSearch
                placeholder="Chọn phân loại mua hàng"
                filterOption={(input, option) =>
                  (option?.label ?? '')
                    .toLowerCase()
                    .includes(input.toLowerCase())
            ...
            >
              <div className="relative">
                <Input
                  ...
                  style={{ backgroundColor: '#e8f0ff', width: 390 }}
                />
