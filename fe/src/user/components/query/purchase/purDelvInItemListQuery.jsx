...
export default function PurDelvInItemListQuery({
  fromDate,
  setFromDate,
  setToDate,
  toDate,
        ...
        <Row className="gap-4 flex items-center mb-4">
          ...
          <Col>
            ...
            >
              <Input
                value={pOMngNo}
                onChange={(e) => setPOMngNo(e.target.value)}
                size="middle"
                style={{
                  width: 190,
                }}
          ...
          <Col>
            ...
            >
              <Input
                value={delvInNo}
                onChange={(e) => setDelvInNo(e.target.value)}
                size="middle"
                style={{
                  width: 190,
                }}
