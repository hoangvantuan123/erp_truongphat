...
export default function PdsfcMatProgressListQuery({
  helpData01,
  setDataSearch,
  setDataSheetSearch,
  setItemText,
    ...
    <div className="flex items-center gap-2">
      <Form layout="vertical">
        ...
        <Row className="gap-4 flex items-center ">
          ...
          <Col>
            <Form.Item
              label={<span className="uppercase text-[10px]">{t('2034')}</span>}
              style={{ marginBottom: 0 }}
              labelCol={{ style: { marginBottom: 2, padding: 0 } }}
              wrapperCol={{ style: { padding: 0 } }}
            >
          ...
          <Col>
            <Form.Item
              label={<span className="uppercase text-[10px]">{t('2035')}</span>}
              style={{ marginBottom: 0 }}
              labelCol={{ style: { marginBottom: 2, padding: 0 } }}
              wrapperCol={{ style: { padding: 0 } }}
            >
          ...
          <Col>
            <Form.Item
              ...
              wrapperCol={{ style: { padding: 0 } }}
            >
              <Input placeholder="" size="middle" onChange={(e) =>(setMatItemName(e.target.value))} value={MatItemName} />
            </Form.Item>
          </Col>
          <Col>
            <Form.Item
              label={<span className="uppercase text-[10px]">{t('2169')}</span>}
              style={{ marginBottom: 0 }}
              labelCol={{ style: { marginBottom: 2, padding: 0 } }}
              wrapperCol={{ style: { padding: 0 } }}
            >
              <Input placeholder="" size="middle" onChange={(e) =>(setMatItemNo(e.target.value))} value={MatItemNo} />
            </Form.Item>
          </Col>
