...
export default function PdsfcWorkReportListQuery({
  helpData01,
  setDataSearch,
  setDataSheetSearch,
  setItemText,
  ...
  setWorkType,
  WorkType,
  setRealLotNo, RealLotNo,

  AssyItemName,
  AssyItemNo,
  setAssyItemNo, setAssyItemName,
    ...
    <div className="flex items-center gap-2">
      <Form layout="vertical">
        <Row className="gap-4 flex items-center ">
          ...
          <Col>
            <Form.Item
              label={<span className="uppercase text-[10px]">{t('1981')}</span>}
              style={{ marginBottom: 0 }}
              labelCol={{ style: { marginBottom: 2, padding: 0 } }}
              wrapperCol={{ style: { padding: 0 } }}
            >
        ...
        <Row className="gap-4 flex items-center ">
          ...
          <Col>
            <Form.Item
              ...
              wrapperCol={{ style: { padding: 0 } }}
            >
              <Input placeholder="" size="middle" onChange={(e) => (setRealLotNo(e.target.value))} value={RealLotNo} />
            </Form.Item>
          </Col>
          <Col>
            <Form.Item
              label={<span className="uppercase text-[10px]">{t('37597')}</span>}
              style={{ marginBottom: 0 }}
              labelCol={{ style: { marginBottom: 2, padding: 0 } }}
              wrapperCol={{ style: { padding: 0 } }}
            >
              <Input placeholder="" size="middle" onChange={(e) => (setItemName(e.target.value))} value={ItemName} />
            </Form.Item>
          </Col>
          <Col>
            <Form.Item
              label={<span className="uppercase text-[10px]">{t('37605')}</span>}
              style={{ marginBottom: 0 }}
              labelCol={{ style: { marginBottom: 2, padding: 0 } }}
              wrapperCol={{ style: { padding: 0 } }}
            >
          ...
          <Col>
            <Form.Item
              ...
              wrapperCol={{ style: { padding: 0 } }}
            >
              <Input placeholder="" size="middle" onChange={(e) => (setAssyItemNo(e.target.value))} value={AssyItemName} />
            </Form.Item>
          </Col>
          <Col>
            <Form.Item
              label={<span className="uppercase text-[10px]">{t('2101')}</span>}
              style={{ marginBottom: 0 }}
              labelCol={{ style: { marginBottom: 2, padding: 0 } }}
              wrapperCol={{ style: { padding: 0 } }}
            >
              <Input placeholder="" size="middle" onChange={(e) => (setAssyItemNo(e.target.value))} value={AssyItemNo} />
            </Form.Item>
          </Col>
