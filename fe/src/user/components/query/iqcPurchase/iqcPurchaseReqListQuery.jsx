...
export default function IqcPurchaseReqListQuery({
  dataBizUnit,
  dataSMQcType,
  dataCustomer,
  setBizUnit,
    ...
    <div className="flex items-center gap-2">
      <Form layout="vertical">
        <Row className="gap-4 flex items-center">
          <Col>
            <Form.Item
              label={<span className="uppercase text-[9px]">{t('2')}</span>}
          ...
          <Col>
            <Form.Item
              label={<span className="uppercase text-[9px]">{t('651')}</span>}
              style={{ marginBottom: 0 }}
              labelCol={{ style: { marginBottom: 2, padding: 0 } }}
              wrapperCol={{ style: { padding: 0 } }}
            >
          ...
          <Col>
            <Form.Item
              label={<span className="uppercase text-[9px]">{t('18801')}</span>}
              style={{ marginBottom: 0 }}
              labelCol={{ style: { marginBottom: 2, padding: 0 } }}
              wrapperCol={{ style: { padding: 0 } }}
            >
