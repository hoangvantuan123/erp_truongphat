...
import { Form, Input, Row, Col, DatePicker, Select, message, InputNumber } from 'antd'
import { CompactSelection } from '@glideapps/glide-data-grid'
import CodeHelpPeople from '../../table/codeHelp/codeHelpPeople'
import { useTranslation } from 'react-i18next'
export default function IqcReqDetailQuery({
  dataMaster,
  dataSMQcType,
  dataSMAQLStrict,
  dataSMAQLLevelName,
  ...
  const onChangeDisposeQty = useCallback(
    (data) => {
      ...
      if (RejectQty < data || data < 0) {
        message.error('Số lượng hủy không lớn hơn số lượng lỗi')
        setDisposeQty(0)
      } else {
        setDisposeQty(data)
      }
        ...
        <Form layout="vertical">
          <Row className="gap-4 flex items-center">
            ...
            <Col>
              <Form.Item
                label={
                  <span className="uppercase text-[9px]">{t('10861')}</span>
                }
                style={{ marginBottom: 0 }}
                labelCol={{ style: { marginBottom: 2, padding: 0 } }}
                wrapperCol={{ style: { padding: 0 } }}
            ...
            <Col>
              <Form.Item
                label={
                  <span className="uppercase text-[9px]">{t('25500')}</span>
                }
                style={{ marginBottom: 0 }}
                labelCol={{ style: { marginBottom: 2, padding: 0 } }}
                wrapperCol={{ style: { padding: 0 } }}
            ...
            <Col>
              ...
              >
                <InputNumber
                  ...
                  value={ReqSampleQty}
                  onChange={(e) => {
                    setReqSampleQty(e.target.value)
                  }}
                  disabled="fasle"
                  formatter={(value) =>
                    value != null
      ...
      <div className="flex p-2 mt-1 gap-4 group [&_summary::-webkit-details-marker]:hidden border rounded-lg bg-white">
        <Form layout="vertical">
          <Row className="gap-4 flex items-center">
            <Col>
              <Form.Item
                label={<span className="uppercase text-[9px]">{t('6411')}</span>}
                style={{ marginBottom: 0 }}
                labelCol={{ style: { marginBottom: 2, padding: 0 } }}
                wrapperCol={{ style: { padding: 0 } }}
              >
          ...
          <Col>
              <Form.Item
                label={<span className="uppercase text-[9px]">{t('8017')}</span>}
                style={{ marginBottom: 0 }}
                labelCol={{ style: { marginBottom: 2, padding: 0 } }}
                wrapperCol={{ style: { padding: 0 } }}
              >
            ...
            <Col>
              <Form.Item
                label={<span className="uppercase text-[9px]">{t('2203')}</span>}
                style={{ marginBottom: 0 }}
                labelCol={{ style: { marginBottom: 2, padding: 0 } }}
                wrapperCol={{ style: { padding: 0 } }}
              >
            ...
            <Col>
              <Form.Item
                label={<span className="uppercase text-[9px]">{t('2201')}</span>}
                style={{ marginBottom: 0 }}
                labelCol={{ style: { marginBottom: 2, padding: 0 } }}
                wrapperCol={{ style: { padding: 0 } }}
              >
            ...
            <Col>
              <Form.Item
                label={<span className="uppercase text-[9px]">{t('10537')}</span>}
                style={{ marginBottom: 0 }}
                labelCol={{ style: { marginBottom: 2, padding: 0 } }}
                wrapperCol={{ style: { padding: 0 } }}
              >
            ...
            <Col>
              <Form.Item
                label={<span className="uppercase text-[9px]">{t('6024')}</span>}
                style={{ marginBottom: 0 }}
                labelCol={{ style: { marginBottom: 2, padding: 0 } }}
                wrapperCol={{ style: { padding: 0 } }}
              >
            ...
            <Col>
              <Form.Item
                label={<span className="uppercase text-[9px]">{t('14400')}</span>}
                style={{ marginBottom: 0 }}
                labelCol={{ style: { marginBottom: 2, padding: 0 } }}
                wrapperCol={{ style: { padding: 0 } }}
              >
            ...
            <Col>
              <Form.Item
                label={<span className="uppercase text-[9px]">{t('14422')}</span>}
                style={{ marginBottom: 0 }}
                labelCol={{ style: { marginBottom: 2, padding: 0 } }}
                wrapperCol={{ style: { padding: 0 } }}
              >
