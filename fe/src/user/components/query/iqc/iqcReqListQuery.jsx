...
export default function IqcReqListQuery({
  dataBizUnit,
  dataSMQcType,
  dataCustomer,
  ...
  const onChangeAsset = (data) => {
    const itemSelect = dataAsset.find((item) => item.Value === data)
    if (itemSelect) {
      ...
      <Form layout="vertical">
        <Row className="gap-4 flex items-center">
          ...
          <Col>
            <Form.Item
              label={
                <span className="uppercase text-[10px]">{t('31725')}</span>
              }
              style={{ marginBottom: 0 }}
              labelCol={{ style: { marginBottom: 2, padding: 0 } }}
              wrapperCol={{ style: { padding: 0 } }}
          ...
          <Col>
            <Form.Item
              label={
                <span className="uppercase text-[10px]">{t('210')}</span>
              }
              style={{ marginBottom: 0 }}
              labelCol={{ style: { marginBottom: 2, padding: 0 } }}
              wrapperCol={{ style: { padding: 0 } }}
          ...
          <Col>
            <Form.Item
              label={
                <span className="uppercase text-[9px]">{t('360')}</span>
              }
              style={{ marginBottom: 0 }}
              labelCol={{ style: { marginBottom: 2, padding: 0 } }}
              wrapperCol={{ style: { padding: 0 } }}
