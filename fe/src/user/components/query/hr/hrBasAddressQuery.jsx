...
export default function HrBasAddressQuery({
    helpData01,
    helpData02,
    helpData03,
    searchText,
    ...
    const handleChangeSMAddressType = (value) => {
        setSMAddressType(value)
    }
    return (
        <div className="flex items-center gap-2">
            <Form layout="vertical" variant='filled'>
                <Row className="gap-4 flex items-center ">
                    ...
                    <Col>
                        <Form.Item
                            label={<span className="uppercase text-[9px]">{t('Loại địa chỉ ')} </span>}
                            style={{ marginBottom: 0 }}
                            labelCol={{ style: { marginBottom: 2, padding: 0 } }}
                            wrapperCol={{ style: { padding: 0 } }}
                        >
                            <Select
                                ...
                                onChange={handleChangeSMAddressType}
                                options={[
                                    { label: 'All', value: '' },
                                    ...(helpData03?.map((item) => ({
                    ...
                    <Col>
                        <Form.Item
                            label={<span className="uppercase text-[9px]">{t('Địa chỉ')} </span>}
                            style={{ marginBottom: 0 }}
                            labelCol={{ style: { marginBottom: 2, padding: 0 } }}
                            wrapperCol={{ style: { padding: 0 } }}
                        >
