...
import Dropdown40095 from '../../../sheet/query/dropDown40095'
import Dropdown40002 from '../../../sheet/query/dropDown40002'
dayjs.locale('vi')

export default function AcctBalanceQuery({
    formData,
    setFormData,
    toDate,
    setToDate,
            ...
            <div className="flex flex-col gap-2 p-2">
                <Form variant="filled">
                    ...
                    <Row gutter={[16, 8]} className="mt-2">
                        <Col>
                            <Form.Item
                                label={<span className="uppercase text-[10px]">{t('30857')}</span>}
                                style={{ marginBottom: 0 }}
                            >
                                <Input
                                    placeholder=""
                            ...
                            >
                                <Space>
                                    ...
                                    <Input
                                        readOnly
                                        style={{ width: '100px' }}
                                        value={dataSearch4?.AccNo ? dataSearch4?.AccNo : ''}
                                    />
                                </Space>
                            </Form.Item>
                        </Col>
