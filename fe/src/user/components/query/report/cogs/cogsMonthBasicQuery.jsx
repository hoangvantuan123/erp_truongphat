...
export default function CogsMonthBasicQuery({
            ...
            <div className="flex flex-col gap-2 p-2">
                <Form variant="filled">
                        ...
                        <Col>
                            ...
                            >
                                <DatePicker
                                    picker="year"
                                    format="YYYY"
                                    value={CostYY ? dayjs(CostYY, 'YYYY') : null}
                                    onChange={(value) => {
                                        if (value) {
                                            setCostYY(value.format('YYYY'));
                                        } else {
                                            setCostYY('');
                                        }
                                    }}
                    ...
                    <Row gutter={[16, 8]} className='mt-2'>
                        ...
                        <Col>
                            <Form.Item
                                label={<span className="uppercase text-[10px]">{t('10045509')}</span>}
                                style={{ marginBottom: 0 }}
                            >
                                <Select
                                    style={{ width: 180 }}
