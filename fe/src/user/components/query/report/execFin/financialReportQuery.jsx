...
export default function FinancialReportQuery({
    formData,
    setFormData,
    toDate,
    setToDate,
            ...
            <div className="flex flex-col gap-2 p-2">
                <Form variant="filled">
                    ...
                    <Row gutter={[16, 8]}>
                        ...
                        <Col>
                            <Form.Item
                                label={<span className="uppercase text-[10px]">{t('24455')}</span>}
                                style={{ marginBottom: 0 }}
                            >
                                <Space>
                                    <DatePicker
                        ...
                        <Col>
                            <Form.Item name="showDetail" initialValue={true} style={{ marginBottom: 0 }}>
                                <Checkbox
                                    defaultChecked
                                    onChange={(e) => setIsInit(e.target.checked ? 1 : 0)}
                                >
                                    {t('2326')}
                                </Checkbox>
                            </Form.Item>
                        ...
                        <Col>
                            <Form.Item name="showDetail" initialValue={true} style={{ marginBottom: 0 }}>
                                <Checkbox
                                    defaultChecked
                                    onChange={(e) => setPrevIsInit(e.target.checked ? 1 : 0)}
                                >
                                    {t('37788')}
                                </Checkbox>
                            </Form.Item>
                    ...
                    <Row gutter={[16, 8]} className="mt-2">
                        <Col>
                            <Form.Item
                                label={<span className="uppercase text-[10px]">{t('24275')}</span>}
                                style={{ marginBottom: 0 }}
                            >
                                <Space>
                                    <DatePicker
