...
if (baseUrl === '192.168.35.150:3030') {
  ...
  HOST_API_SERVER_4 = 'https://192.168.35.150:3030/dev2/api/v4'
  ...
  HOST_API_SERVER_1 = 'https://192.168.35.150:8080/sv1/api/v1'
  HOST_API_SERVER_2 = 'https://192.168.35.150:8080/sv1/api/v2'
  HOST_API_SERVER_3 = 'https://192.168.35.150:8080/sv1/api/v3'
  HOST_API_SERVER_4 = 'https://192.168.35.150:8080/sv2/api/v4'
  HOST_API_SERVER_5 = 'https://192.168.35.150:8080/sv2/uploads'
  HOST_API_SERVER_1 = 'https://192.168.35.150:8080/sv1/api/v1'
  HOST_API_SERVER_6 = 'https://192.168.35.150:8080/sv1/api/v5'
  HOST_API_SERVER_7 = 'https://192.168.35.150:8080/sv1/api/v7'
  HOST_API_SERVER_8 = 'https://192.168.35.150:8080/sv2/api'
  HOST_API_SERVER_9 = 'https://192.168.35.150:8080/sv2/c/invoice/'
  HOST_API_SERVER_10 = 'https://192.168.35.150:8080/sv3/api/qrcode?url='
  HOST_API_SERVER_10 = 'https://192.168.35.150:8080/sv3/api/qrcode?url='
  HOST_API_SERVER_11 = 'https://192.168.35.150:8080/sv2/print/file'
  HOST_API_SERVER_12 = 'https://192.168.35.150:8080/sv1/api/v6'
  HOST_API_SERVER_13 = 'https://192.168.35.150:8080/sv1/api/v13'
  HOST_API_SERVER_14 = 'https://192.168.35.150:8080/sv2/public-files'
  HOST_API_SERVER_15 = 'https://192.168.35.150:8080/sv1/api/v8'

  HOST_API_SERVER_16 = 'https://192.168.35.150:8080/sv1/api/v14'
  HOST_API_SERVER_17 = 'https://192.168.35.150:8080/sv1/api/v15'
  HOST_API_SERVER_18 = 'https://192.168.35.150:8080/sv1/api/v18'
  HOST_API_SERVER_PUBIC = 'https://192.168.35.150:8080/sv2/'
  ...
  HOST_API_SERVER_4 = 'http://localhost:8089/api/v4'
  HOST_API_SERVER_5 = 'http://localhost:8089/uploads'
  HOST_API_SERVER_6 = 'http://localhost:8086/api/v5'
  HOST_API_SERVER_7 = 'http://localhost:8086/api/v7'
  HOST_API_SERVER_8 = 'http://localhost:8089/api'
  HOST_API_SERVER_9 = 'http://localhost:8089/c/invoice/'
  HOST_API_SERVER_10 = 'http://localhost:8098/api/qrcode?url='
  HOST_API_SERVER_11 = 'http://localhost:8089/print/file'
  HOST_API_SERVER_12 = 'http://localhost:8086/api/v6'
  HOST_API_SERVER_13 = 'http://localhost:8086/api/v13'
  HOST_API_SERVER_14 = 'http://localhost:8089/public-files'
  ...
  HOST_API_SERVER_PUBIC = 'http://localhost:8089'
}