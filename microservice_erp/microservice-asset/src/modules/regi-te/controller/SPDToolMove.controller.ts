...
@Controller()
export class RptSalesCatController {
    constructor(private readonly SPDToolMoveService: SPDToolMoveService,
    ...
    @GrpcMethod('SPDToolMoveService', 'SPDToolMoveQ')
    SPDToolMoveQ(request: any): Observable<MetadataResponse> {

        return this.handleGrpcRequest(request, this.SPDToolMoveService.SPDToolMoveQ.bind(this.SPDToolMoveService));
    }

    @GrpcMethod('SPDToolMoveService', 'SPDToolMoveAUD')
    SPDToolMoveAUD(request: any): Observable<MetadataResponse> {

        return this.handleGrpcRequest(request, this.SPDToolMoveService.SPDToolMoveAUD.bind(this.SPDToolMoveService));
    }
