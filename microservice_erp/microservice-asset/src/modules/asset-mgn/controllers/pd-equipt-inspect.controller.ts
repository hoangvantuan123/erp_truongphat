...
@Controller()
export class PdEquiptInspectController {
  constructor(private readonly pdEqpInspect: PdEquiptInspectService) {}
  ...
  @GrpcMethod('PdEquiptInspectService', 'searchEquiptInspect')
  searchEquiptInspect(request: any): Observable<MetadataResponse> {
    return this.handleGrpcRequest(
      request,
      this.pdEqpInspect.searchEquiptInspect.bind(this.pdEqpInspect),
    );
  }

  @GrpcMethod('PdEquiptInspectService', 'createOrUpdatePdEquipInspect')
  createOrUpdatePdEquipInspect(request: any): Observable<MetadataResponse> {
    return this.handleGrpcRequestSave(
      request,
      this.pdEqpInspect.createOrUpdatePdEquipInspect.bind(this.pdEqpInspect),
    );
  }

  @GrpcMethod('PdEquiptInspectService', 'deletePdEquipInspect')
  deletePdEquipInspect(request: any): Observable<MetadataResponse> {
    return this.handleGrpcRequestDelete(
      request,
      this.pdEqpInspect.deletePdEquipInspect.bind(this.pdEqpInspect),
    );
  }
