...
@Injectable()
export class GenerateXmlEtcTransService {
  ...
  async generateXMLSLGInOutReqListQueryWEB(
    ...
    <TransBizUnit>${this.escapeXml(item.TransBizUnit || '')}</TransBizUnit>
    <TransBizUnitName>${this.escapeXml(item.TransBizUnitName || '')}</TransBizUnitName>
    <ReqDateFr>${this.escapeXml(item.ReqDateFr || '')}</ReqDateFr>
    <ReqDateTo>${this.escapeXml(item.ReqDateTo || '')}</ReqDateTo>
    <InWHSeq>${this.escapeXml(item.InWHSeq || '')}</InWHSeq>
    <InWHName>${this.escapeXml(item.InWHName || '')}</InWHName>
  ...
  <BizUnit>${this.escapeXml(item.BizUnit || '')}</BizUnit>
  <BizUnitName>${this.escapeXml(item.BizUnitName || '')}</BizUnitName>
  <ReqBizUnit>${this.escapeXml(item.TransBizUnit || '')}</ReqBizUnit>
  <ReqBizUnitName>${this.escapeXml(item.TransBizUnitName || '')}</ReqBizUnitName>
  ...
  <BizUnit>${this.escapeXml(item.BizUnit || '')}</BizUnit>
  <BizUnitName>${this.escapeXml(item.BizUnitName || '')}</BizUnitName>
  <ReqBizUnit>${this.escapeXml(item.ReqBizUnit || '')}</ReqBizUnit>
  <ReqBizUnitName>${this.escapeXml(item.ReqBizUnitName || '')}</ReqBizUnitName>
  <InOutDate>${this.escapeXml(item.InOutDate || '')}</InOutDate>
  <InOutNo>${this.escapeXml(item.InOutNo || '')}</InOutNo>
  <CustSeq>${this.escapeXml(item.CustSeq || '')}</CustSeq>
  <CustName>${this.escapeXml(item.CustName || '')}</CustName>
