...
@Controller()
export class BizStockListController {
    constructor(private readonly bizStockListService: BizStockListService) { }


    @MessagePattern('slg-wh-biz-stock-list-query')
    async SLGBizUnitStockListQuery(
        ...
        message: 'Invalid or expired token.',
            ...
            try {
                ...
                return this.bizStockListService.SLGBizUnitStockListQuery(result, decodedToken.CompanySeq, decodedToken.UserSeq, 1487) ;
            } catch (error) {
                throw new RpcException({
        statusCode: 401,
        message: 'Invalid or expired token.',
