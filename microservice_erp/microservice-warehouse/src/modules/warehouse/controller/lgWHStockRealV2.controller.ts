...
@Controller()
export class LgWHStockRealV2Controller {
    constructor(private readonly LGWHStockRealV2Service: LGWHStockRealV2Service,
    ...
    @GrpcMethod('StockRealOpenService', 'StockRealOpenQ')
    StockRealOpenQ(request: any): Observable<MetadataResponse> {

        return this.handleGrpcRequest(request, this.LGWHStockRealV2Service.StockRealOpenQ.bind(this.LGWHStockRealV2Service));
    }
    @GrpcMethod('StockRealOpenService', 'SLGWHStockRealOpenQ')
    SLGWHStockRealOpenQ(request: any): Observable<MetadataResponse> {

        return this.handleGrpcRequest(request, this.LGWHStockRealV2Service.SLGWHStockRealOpenQ.bind(this.LGWHStockRealV2Service));
    }
