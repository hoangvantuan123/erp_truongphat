...
export class RptSalesCatController {
    constructor(private readonly rptSalesCatService: RptSalesCatService,
    ...
    @GrpcMethod('SalesReportService', 'SSLEISItemAnalysisQ')
    SSLEISItemAnalysisQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.rptSalesCatService.SSLEISItemAnalysisQ.bind(this.rptSalesCatService));
    }
