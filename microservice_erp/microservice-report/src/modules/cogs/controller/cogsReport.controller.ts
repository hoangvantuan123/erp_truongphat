...
export class CogsReportController {
    constructor(private readonly cogsReportService: CogsReportService,
    ...
    @GrpcMethod('CogsReportService', 'SESMCFProfitAmtQ')
    SESMCFProfitAmtQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.cogsReportService.SESMCFProfitAmtQ.bind(this.cogsReportService));
    }
    @GrpcMethod('CogsReportService', 'SESMCFMnfcostasQ')
    SESMCFMnfcostasQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.cogsReportService.SESMCFMnfcostasQ.bind(this.cogsReportService));
    }
    @GrpcMethod('CogsReportService', 'VTNSESMZProdCostMonListQ')
    VTNSESMZProdCostMonListQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.cogsReportService.VTNSESMZProdCostMonListQ.bind(this.cogsReportService));
    }
    @GrpcMethod('CogsReportService', 'SBAZProdCostItemListQ')
    SBAZProdCostItemListQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.cogsReportService.SBAZProdCostItemListQ.bind(this.cogsReportService));
    }
