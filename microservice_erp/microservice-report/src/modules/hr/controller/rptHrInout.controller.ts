...
@Controller()
export class RptHrInoutController {
    constructor(private readonly rptHrInoutService: RptHrInoutService,
    ...
    @GrpcMethod('HrReportService', 'SHRInfMonthEntRetListQ')
    SHRInfMonthEntRetListQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.rptHrInoutService.SHRInfMonthEntRetListQ.bind(this.rptHrInoutService));
    }
    
    @GrpcMethod('HrReportService', 'SHRInfMonthEntRetGraphList')
    SHRInfMonthEntRetGraphList(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.rptHrInoutService.SHRInfMonthEntRetGraphList.bind(this.rptHrInoutService));
    }
    @GrpcMethod('HrReportService', 'SHRInfEmpEntRetListQ')
    SHRInfEmpEntRetListQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.rptHrInoutService.SHRInfEmpEntRetListQ.bind(this.rptHrInoutService));
    }
