...
@Injectable()
export class IqcPurchaseService {
  constructor(
  ...
  async searchPage(
    ...
    const query = `
      EXEC _SPDQCDelvItemListQuery_Web
  ...
  async saveQcTestList(
    ...
    const xmlDocumentCheck =
      await this.generateXmlService.getQcPurchaseListTestReportCheck(result);
    const queryCheck = `
      EXEC _SPDQcTestReportCheck
        @xmlDocument = N'${xmlDocumentCheck}',
        @xmlFlags = 2,
  ...
  async QcCheckStatusList(
    ...
    const queryCheck = `
      EXEC _SPDQCDelvItemResultListQuery_Web
  ...
  async deleteQcPurchaseTestReport(
    ...
    const xmlDocumentCheck =
      await this.generateXmlService.checkDeleteQcPurchaseTestReport(result);
    const queryCheck = `
      EXEC _SPDQcTestReportCheck
        @xmlDocument = N'${xmlDocumentCheck}',
        @xmlFlags = 2,
