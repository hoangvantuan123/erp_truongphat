...
export class NotificationsController {
    ...
    @GrpcMethod('NotificationService', 'NotificationQ')
    NotificationQ(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.notificationDataService.NotificationQ.bind(this.notificationDataService));
    }
