...
export class PurOrdApprovalReqItemListController {
  constructor(
    private readonly purOrdApprovalReqItemListService: PurOrdApprovalReqItemListService,
  ) {}

  @MessagePattern('sord-approval-req-item-list-sheet-query')
  async SPUORDApprovalReqItemListQueryWEB(
    ...
    try {
      ...
      return this.purOrdApprovalReqItemListService.SPUORDApprovalReqItemListQueryWEB(
        result,
