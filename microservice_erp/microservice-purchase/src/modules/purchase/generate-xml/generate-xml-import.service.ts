...
@Injectable()
export class GenerateXmlImportService {
  ...
  //OrdPO
  async generateXMLSIMPORDERCheckWEB(
    result: Array<{ [key: string]: any }>,
    workingTag: string,
  ): Promise<string> {
    const xmlBlocks = result
  ...
  <DataBlock1>
    ...
    <PORefNo>${this.escapeXml(item.PORefNo || '')}</PORefNo>
    ...
    <ExRate>${this.escapeXml(item.ExRate || '0')}</ExRate>
    <Remark>${this.escapeXml(item.Remark || '')}</Remark>
    <UMPriceTerms>${this.escapeXml(item.UMPriceTerms || '0')}</UMPriceTerms>
    <UMPayment1>${this.escapeXml(item.UMPayment1 || '0')}</UMPayment1>
    <UMPayment2>${this.escapeXml(item.UMPayment2 || '0')}</UMPayment2>
    <Payment3>${this.escapeXml(item.Payment3 || '')}</Payment3>
    <UMShipVia>${this.escapeXml(item.UMShipVia || '0')}</UMShipVia>
    <FundAccSeq />
    <PrePaymentDate />
    <PaymentBankSeq />
  ...
  async generateXMLSIMPORDERItemCheckWEB(
    result: Array<{ [key: string]: any }>,
  ): Promise<string> {
    const xmlBlocks = result
      .map(
  ...
  async generateXMLSIMPORDERSaveWEB(
    result: Array<{ [key: string]: any }>,
  ): Promise<string> {
    const xmlBlocks = result
      .map(
  ...
  async generateXMLSIMPORDERItemSaveWEB(
    result: Array<{ [key: string]: any }>,
  ): Promise<string> {
    const xmlBlocks = result
      .map(
  ...
  async generateXMLSIpmDeliveryQRCheckWEB(
	...
	<CurAmt>${this.escapeXml(item.CurAmt || '')}</CurAmt>
	<PermitQty>${this.escapeXml(item.PermitQty || '')}</PermitQty>
  <PermitAmt>${this.escapeXml(item.PermitAmt || '')}</PermitAmt>
  </DataBlock1>`,
      )
      .join('');
  ...
  <IsChangedMst>1</IsChangedMst>
  <BizUnit>${this.escapeXml(item.BizUnit || '')}</BizUnit>
  <Date>${this.escapeXml(item.PODate || '')}</Date>
  <ServiceSeq>2657</ServiceSeq>
  <MethodSeq>7</MethodSeq>
  ...
  <Status>0</Status>
    ...
    <Price>${this.escapeXml(item.Price || '')}</Price>
    <CurAmt>${this.escapeXml(item.CurAmt || '')}</CurAmt>
    <DomAmt>${this.escapeXml(item.CurAmt || '')}</DomAmt>
    <WHName>${this.escapeXml(item.WHName || '')}</WHName>
    <LotNo>${this.escapeXml(item.LotNo || '')}</LotNo>
    <FromSerlNo />
    <ToSerlNo />
  ...
  async generateXMLSSLImpDelvSheetSaveWEB(
    ...
    <Price>${this.escapeXml(item.Price || '')}</Price>
    <CurAmt>${this.escapeXml(item.CurAmt || '')}</CurAmt>
    <DomAmt>${this.escapeXml(item.DomAmt || '')}</DomAmt>
    <WHSeq>${this.escapeXml(item.WHSeq || '')}</WHSeq>
    <LotNo>${this.escapeXml(item.LotNo || '')}</LotNo>
    <FromSerlNo />
    <ToSerlNo />
  ...
  async generateXMLSIMPORDERListQueryWEB(
    result: Array<{ [key: string]: any }>,
  ): Promise<string> {
    const xmlBlocks = result
      .map(
  ...
  async generateXMLSIMPORDERMasterQueryWEB(
    result: Array<{ [key: string]: any }>,
  ): Promise<string> {
    const xmlBlocks = result
      .map(
  ...
  async generateXMLSIMPORDERSheetQueryWEB(
    result: Array<{ [key: string]: any }>,
  ): Promise<string> {
    const xmlBlocks = result
      .map(
  ...
  async generateXMLSIMPORDERMasterLinkQueryWEB(
    result: Array<{ [key: string]: any }>,
  ): Promise<string> {
    const xmlBlocks = result
      .map(
  ...
  async generateXMLSIMPORDERSheetLinkQueryWEB(
    result: Array<{ [key: string]: any }>,
  ): Promise<string> {
    const xmlBlocks = result
      .map(
  ...
  async generateXMLSIMPORDERItemListQueryWEB(
    result: Array<{ [key: string]: any }>,
  ): Promise<string> {
    const xmlBlocks = result
      .map(
