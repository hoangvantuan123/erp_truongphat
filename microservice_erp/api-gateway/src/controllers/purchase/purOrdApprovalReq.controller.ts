...
export class PurOrdApprovalReqController {
  constructor(
  ...
  @Post('sord-approval-req-master-query')
  async SPUORDApprovalReqMasterQueryWEB(
    ...
    const resu = await this.sendRequest('sord-approval-req-master-query', {
      result,
      authorization,
    });
  ...
  @Post('sord-approval-req-sheet-query')
  async SPUORDApprovalReqSheetQueryWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('sord-approval-req-sheet-query', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SOrdApprovalReqSave(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('sord-approval-req-aud', {
      dataMaster,
      dataSheetAUD,
      authorization,
    });
  ...
  @Post('sord-approval-req-master-delete')
  async SOrdApprovalReqDelete(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('sord-approval-req-master-delete', {
      dataMaster,
      dataSheetAUD,
      authorization,
    });
  ...
  @Post('sord-approval-req-sheet-delete')
  async SOrdApprovalReqSheetDelete(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('sord-approval-req-sheet-delete', {
      dataMaster,
      dataSheetAUD,
      authorization,
    });
