...
export class PurOrdApprovalReqListController {
  ...
  @Post('sord-approval-req-list-sheet-query')
  async SPUORDApprovalReqListQueryWEB(
    ...
    const resu = await this.sendRequest('sord-approval-req-list-sheet-query', {
      result,
      authorization,
    });
  ...
  @Post('sord-approval-req-list-confirm')
  async SCOMConfirmWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('sord-approval-req-list-confirm', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  @Post('sord-approval-req-list-stop')
  async SApprovalReqStopWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('sord-approval-req-list-stop', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
