...
export class IqcOutsourceController {
  ...
  async searchBy(
    ...
    const resu = await this.sendRequest('search-iqc-outsource-by', { result, authorization });
    return res.status(HttpStatus.OK).json(resu);
  }
 
  @Post('get-iqc-outsource-by-id')
  async getById(
    @Body('result') result: any[],
    @Req() req: Request,
    @Res() res: Response,
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('get-iqc-outsource-by-id', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async createdBy(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('created-iqc-outsource-by', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  @Post('created-iqc-outsource-list')
  async createdListBy(
    @Body('result') result: any[],
    @Req() req: Request,
    @Res() res: Response,
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('created-iqc-outsource-list', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async QcTestReportSampleReq(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('iqc-outsource-sample', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  @Post('list-qc-outsource-test-report')
  async GetListQcTestReportBatch(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('list-qc-outsource-test-report', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SearchIqcCheckStatus(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('iqc-outsource-status', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  @Post('delete-iqc-outsource-by')
  async DeleteIqcOutsourceBy(
    @Body('result') result: any [],
    @Req() req: Request,
    @Res() res: Response,
  ) {
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('delete-iqc-outsource-by', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
