...
export class EtcOutReqController {
  ...
  async SLGInOutReqListQueryWEB(
    ...
    const resu = await this.sendRequest('slg-in-out-req-list-out', {
      result,
      authorization,
    });
  ...
  async SLGInOutReqItemListQueryWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-req-item-list-out', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SLGInOutReqItemQueryWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-req-sheet-query-out', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SLGInOutReqQueryWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-req-master-query-out', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SLGInOutItemListQueryWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-item-list-out', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SCOMConfirmWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-req-list-confirm-out', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SLGInOutReqStopSaveWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-req-list-stop-out', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SLGInOutReqSave(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-req-aud-out', {
      dataMaster,
      dataSheetAUD,
      authorization,
    });
  ...
  async SLGInOutReqDelete(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-req-master-delete-out', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SLGInOutReqSheetDelete(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-req-sheet-delete-out', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  //Begin TuanNN
  @Post('slg-in-out-tp-sheet-query-out')
  async SLGInOutTPItemQueryWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-tp-sheet-query-out', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  }
  @Post('slg-in-out-tp-master-query-out')
  async SLGInOutTPQueryWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-tp-master-query-out', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  }
  @Post('slg-in-out-tp-aud-out')
  async SLGInOutTPSave(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-tp-aud-out', {
      dataMaster,
      dataSheetAUD,
      authorization,
    });
  ...
  @Post('slg-in-out-tp-master-delete-out')
  async SLGInOutTPDelete(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-tp-master-delete-out', {
      dataMaster,
      dataSheetAUD,
      authorization,
    });
  ...
  @Post('slg-in-out-tp-sheet-delete-out')
  async SLGInOutTPSheetDelete(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-tp-sheet-delete-out', {
      dataMaster,
      dataSheetAUD,
      authorization,
    });
  ...
  async SLGEtcInReqQuery2WEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-req2-sheet-query-out', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SLGEtcInSheetQueryWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-sheet-query-out', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SEtcOutQRCheckWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-qr-check-out', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SLGInOutInventoryCheckWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-inventory-check', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SLGInOutSave(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-aud-out', {
      dataMaster,
      dataSheetAUD,
      authorization,
    });
  ...
  async SLGInOutSheetDelete(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-sheet-delete-out', {
      dataMaster,
      dataSheetAUD,
      authorization,
    });
  ...
  async SLGInOutMasterDelete(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-master-delete-out', {
      dataMaster,
      dataSheetAUD,
      authorization,
    });
