...
@Controller('v1/mssql/lg-wh-item')
export class LGWHItemController {
    ...
    async SDAWHCaseItemQuery(
        ...
        const resu = await this.sendRequest('sda-wh-case-item', { result, authorization });
    ...
    async SDAWHItemQuery(
        ...
        const authorization = this.getAuthorization(req);
        const resu = await this.sendRequest('sda-wh-item', { result, authorization });
        return res.status(HttpStatus.OK).json(resu);
    }
    @Post('sda-wh-item-auto-create')
    async SDAWHAutoCheckCreate(
        ...
        const authorization = this.getAuthorization(req);
        const resu = await this.sendRequest('sda-wh-item-auto-create', { result, authorization });
        return res.status(HttpStatus.OK).json(resu);
    }
    @Post('sda-wh-item-auto-update')
    async SDAWHAutoCheckU(
        ...
        const authorization = this.getAuthorization(req);
        const resu = await this.sendRequest('sda-wh-item-auto-update', { result, authorization });
        return res.status(HttpStatus.OK).json(resu);
    }
    @Post('sda-wh-item-auto-delete')
    async SDAWHAutoCheckD(
        ...
        const authorization = this.getAuthorization(req);
        const resu = await this.sendRequest('sda-wh-item-auto-delete', { result, authorization });
        return res.status(HttpStatus.OK).json(resu);
    }
