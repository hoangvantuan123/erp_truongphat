...
export class EtcTransReqController {
  ...
  async SLGInOutReqListQueryWEB(
    ...
    const resu = await this.sendRequest('slg-in-out-req-list-trans', {
      result,
      authorization,
    });
  ...
  async SLGInOutReqItemListQueryWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-req-item-list-trans', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SLGInOutReqItemQueryWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-req-sheet-query-trans', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SLGInOutReqQueryWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-req-master-query-trans', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SLGInOutItemListQueryWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-item-list-trans', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SCOMConfirmWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-req-list-confirm-trans', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SLGInOutReqStopSaveWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-req-list-stop-trans', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SLGInOutReqSave(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-req-aud-trans', {
      dataMaster,
      dataSheetAUD,
      authorization,
    });
  ...
  async SLGInOutReqDelete(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-req-master-delete-trans', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SLGInOutReqSheetDelete(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-req-sheet-delete-trans', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  //Begin TuanNN
  @Post('slg-in-out-tp-sheet-query-trans')
  async SLGInOutTPItemQueryWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-tp-sheet-query-trans', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  }
  @Post('slg-in-out-tp-master-query-trans')
  async SLGInOutTPQueryWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-tp-master-query-trans', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  }
  @Post('slg-in-out-tp-aud-trans')
  async SLGInOutTPSave(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-tp-aud-trans', {
      dataMaster,
      dataSheetAUD,
      authorization,
    });
  ...
  @Post('slg-in-out-tp-master-delete-trans')
  async SLGInOutTPDelete(
    @Body('dataMaster') dataMaster: any[],
    @Body('dataSheetAUD') dataSheetAUD: any[],
    @Req() req: Request,
    @Res() res: Response,
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-tp-master-delete-trans', {
      dataMaster,
      dataSheetAUD,
      authorization,
    });
  ...
  @Post('slg-in-out-tp-sheet-delete-trans')
  async SLGInOutTPSheetDelete(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-tp-sheet-delete-trans', {
      dataMaster,
      dataSheetAUD,
      authorization,
    });
  ...
  async SLGEtcInReqQuery2WEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-req2-sheet-query-trans', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SLGEtcInSheetQueryWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-sheet-query-trans', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SEtcTransQRCheckWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-qr-check-trans', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SLGInOutInventoryCheckWEB(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-inventory-trans', {
      result,
      authorization,
    });
    return res.status(HttpStatus.OK).json(resu);
  ...
  async SLGInOutSave(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-aud-trans', {
      dataMaster,
      dataSheetAUD,
      authorization,
    });
  ...
  async SLGInOutSheetDelete(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-sheet-delete-trans', {
      dataMaster,
      dataSheetAUD,
      authorization,
    });
  ...
  async SLGInOutMasterDelete(
    ...
    const authorization = this.getAuthorization(req);
    const resu = await this.sendRequest('slg-in-out-master-delete-trans', {
      dataMaster,
      dataSheetAUD,
      authorization,
    });
