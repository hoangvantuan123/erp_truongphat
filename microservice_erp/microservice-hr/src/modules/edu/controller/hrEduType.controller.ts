...
export class HrEduTypeController {
  constructor(
    private readonly hrEduTypeService: HrEduTypeService,
  ...
  @GrpcMethod('HrEduTypeService', 'searchEduType')
  searchEduType(request: any[]): Observable<MetadataResponse> {
    return this.handleGrpcRequest(
      request,
      this.hrEduTypeService.searchEduType.bind(this.hrEduTypeService),
    );
  }

  @GrpcMethod('HrEduTypeService', 'auEduType')
  auEduType(request: any): Observable<MetadataResponse> {
    return this.handleGrpcRequest(
      request,
      this.hrEduTypeService.auEduType.bind(this.hrEduTypeService),
    );
  }

  @GrpcMethod('HrEduTypeService', 'deleteEduType')
  deleteEduType(request: any): Observable<MetadataResponse> {
    return this.handleGrpcRequest(
      request,
      this.hrEduTypeService.deleteEduType.bind(this.hrEduTypeService),
    );
  }
  // @GrpcMethod('HrEduTypeService', 'HrBasAcademicD')
  // HrBasAcademicD(request: any): Observable<MetadataResponse> {
  //   return this.handleGrpcRequest(
  //     request,
  //     this.hrEduTypeService.HrBasAcademicD.bind(this.hrEduTypeService),
  //   );
  // }
}
