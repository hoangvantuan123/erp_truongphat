...
export class SearchStatiticController {
  constructor(private readonly searchStatiticService: SearchStatisticService , private readonly databaseService: DatabaseService) { }
  ...
  @GrpcMethod('SearchStatisticService', 'searchInfoMonthPerCnt')
  searchDaDept(request: any): Observable<MetadataResponse> {
      return this.handleGrpcRequest(request, this.searchStatiticService.searchInfoMonthPerCnt.bind(this.searchStatiticService));
  }


  @GrpcMethod('SearchStatisticService', 'searchInfoEmpList')
  searchInfoEmpList(request: any[]): Observable<MetadataResponse> {
      return this.handleGrpcRequest(request, this.searchStatiticService.searchInfoEmpList.bind(this.searchStatiticService));
  }

    @GrpcMethod('SearchStatisticService', 'searchInfoMultiEmpList')
    searchInfoMultiEmpList(request: any[]): Observable<MetadataResponse> {
      return this.handleGrpcRequest(request, this.searchStatiticService.searchInfoMultiEmpList.bind(this.searchStatiticService));
  }
