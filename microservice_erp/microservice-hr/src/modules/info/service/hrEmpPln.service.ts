...
export class HrEmpPlnService {
    ...
    HrEmpPlnQ(result: any, companySeq: number, userSeq: number): Observable<SimpleQueryResult> {
        const xmlDocument = this.generateXmlService.generateXMLSHREmpInQ(result);
        const query = `
            EXEC _SHREmpInQuery_WEB
    ...
    HrEmpPlnA(result: any[], companySeq: number, userSeq: number, workingTag: string): Observable<any> {
        return this.HrEmpPlnAUD(result, companySeq, userSeq, 'A');
    }
    HrEmpPlnU(result: any[], companySeq: number, userSeq: number, workingTag: string): Observable<any> {
        return this.HrEmpPlnAUD(result, companySeq, userSeq, 'U');
    }
    HrEmpPlnD(result: any[], companySeq: number, userSeq: number, workingTag: string): Observable<any> {
        return this.HrEmpPlnAUD(result, companySeq, userSeq, 'D');
    }
