...
@Injectable()
export class HrBaseFamilyService {
    constructor(
    ...
    HrBaseFamilyQ(result: any, companySeq: number, userSeq: number): Observable<SimpleQueryResult> {
        const xmlDocument = this.generateXmlService.generateXMLSHRBasFamilyQ(result);
        const query = `
            EXEC _SHRBasFamilyQuery_WEB
    ...
    private HrBaseFamilyAUD(result: any[], companySeq: number, userSeq: number, workingTag: string): Observable<any> {
        const xmlFlags = 2;
        const languageSeq = 6;
    ...
    HrBaseFamilyA(result: any[], companySeq: number, userSeq: number, workingTag: string): Observable<any> {
        return this.HrBaseFamilyAUD(result, companySeq, userSeq, 'A');
    }

    HrBaseFamilyU(result: any[], companySeq: number, userSeq: number, workingTag: string): Observable<any> {
        return this.HrBaseFamilyAUD(result, companySeq, userSeq, 'U');
    }
    HrBaseFamilyD(result: any[], companySeq: number, userSeq: number, workingTag: string): Observable<any> {
        return this.HrBaseFamilyAUD(result, companySeq, userSeq, 'D');
    }
