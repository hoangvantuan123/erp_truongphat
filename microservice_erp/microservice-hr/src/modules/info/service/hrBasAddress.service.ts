...
@Injectable()
export class HrBasAddressService {
    constructor(
    ...
    HrBasAddressQ(result: any, companySeq: number, userSeq: number): Observable<SimpleQueryResult> {
        const xmlDocument = this.generateXmlService.generateXMLHrBasAddressQ(result);
        const query = `
            EXEC _SHRBasAddressQuery_WEB
    ...
    HrBasAddressA(result: any[], companySeq: number, userSeq: number, workingTag: string): Observable<any> {
        return this.HrBasAddressAUD(result, companySeq, userSeq, 'A');
    }

    HrBasAddressU(result: any[], companySeq: number, userSeq: number, workingTag: string): Observable<any> {
        return this.HrBasAddressAUD(result, companySeq, userSeq, 'U');
    }
    HrBasAddressD(result: any[], companySeq: number, userSeq: number, workingTag: string): Observable<any> {
        return this.HrBasAddressAUD(result, companySeq, userSeq, 'D');
    }
