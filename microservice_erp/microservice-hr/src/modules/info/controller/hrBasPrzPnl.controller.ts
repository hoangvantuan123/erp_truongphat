...
@Controller()
export class HrBasPrzPnlController {
    constructor(private readonly hrBasPrzPnlService: HrBasPrzPnlService, private readonly databaseService: DatabaseService) { }
    ...
    @GrpcMethod('HrBasPrzPnlService', 'HrBasPrzPnlA')
    HrBasPrzPnlA(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasPrzPnlService.HrBasPrzPnlA.bind(this.hrBasPrzPnlService));
    }
    @GrpcMethod('HrBasPrzPnlService', 'HrBasPrzPnlU')
    HrBasPrzPnlU(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasPrzPnlService.HrBasPrzPnlU.bind(this.hrBasPrzPnlService));
    }
    @GrpcMethod('HrBasPrzPnlService', 'HrBasPrzPnlD')
    HrBasPrzPnlD(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasPrzPnlService.HrBasPrzPnlD.bind(this.hrBasPrzPnlService));
    }
    @GrpcMethod('HrBasPrzPnlService', 'HrBasPrzPnlQ')
    HrBasPrzPnlQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasPrzPnlService.HrBasPrzPnlQ.bind(this.hrBasPrzPnlService));
    }
}