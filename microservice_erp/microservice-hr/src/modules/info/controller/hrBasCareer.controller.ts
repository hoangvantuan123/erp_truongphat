...
@Controller()
export class HrBasCareerController {
    constructor(private readonly hrBasCareerService: HrBasCareerService, private readonly databaseService: DatabaseService) { }
    ...
    @GrpcMethod('HrBasCareerService', 'HrBasCareerA')
    HrBasCareerA(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasCareerService.HrBasCareerA.bind(this.hrBasCareerService));
    }
    @GrpcMethod('HrBasCareerService', 'HrBasCareerU')
    HrBasCareerU(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasCareerService.HrBasCareerU.bind(this.hrBasCareerService));
    }
    @GrpcMethod('HrBasCareerService', 'HrBasCareerD')
    HrBasCareerD(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasCareerService.HrBasCareerD.bind(this.hrBasCareerService));
    }
    @GrpcMethod('HrBasCareerService', 'HrBasCareerQ')
    HrBasCareerQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasCareerService.HrBasCareerQ.bind(this.hrBasCareerService));
    }
}