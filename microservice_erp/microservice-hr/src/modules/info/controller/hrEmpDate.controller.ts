...
export class HrEmpDateController {
    constructor(private readonly hrEmpDateService: HrEmpDateService, private readonly databaseService: DatabaseService) { }
    ...
    @GrpcMethod('HrEmpDateService', 'HrEmpDateQ')
    HrEmpDateQ(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrEmpDateService.HrEmpDateQ.bind(this.hrEmpDateService));
    }
