...
@Controller()
export class EmpUserDefineController {
    constructor(private readonly empUserDefineService: EmpUserDefineService, private readonly databaseService: DatabaseService) { }
    ...
    @GrpcMethod('EmpUserDefineService', 'EmpUserDefineU')
    EmpUserDefineU(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.empUserDefineService.EmpUserDefineU.bind(this.empUserDefineService));
    }

    @GrpcMethod('EmpUserDefineService', 'EmpUserDefineQ')
    EmpUserDefineQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.empUserDefineService.EmpUserDefineQ.bind(this.empUserDefineService));
    }
    @GrpcMethod('EmpUserDefineService', 'AdmOrdEmpListQ')
    AdmOrdEmpListQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.empUserDefineService.AdmOrdEmpListQ.bind(this.empUserDefineService));
    }
}