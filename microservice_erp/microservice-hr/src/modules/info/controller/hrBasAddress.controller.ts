...
@Controller()
export class HrBasAddressController {
    constructor(private readonly hrBasAddressService: HrBasAddressService, private readonly databaseService: DatabaseService) { }
    ...
    @GrpcMethod('HrBasAddressService', 'HrBasAddressA')
    HrBasAddressA(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasAddressService.HrBasAddressA.bind(this.hrBasAddressService));
    }
    @GrpcMethod('HrBasAddressService', 'HrBasAddressU')
    HrBasAddressU(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasAddressService.HrBasAddressU.bind(this.hrBasAddressService));
    }
    @GrpcMethod('HrBasAddressService', 'HrBasAddressD')
    HrBasAddressD(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasAddressService.HrBasAddressD.bind(this.hrBasAddressService));
    }
    @GrpcMethod('HrBasAddressService', 'HrBasAddressQ')
    HrBasAddressQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasAddressService.HrBasAddressQ.bind(this.hrBasAddressService));
    }
}