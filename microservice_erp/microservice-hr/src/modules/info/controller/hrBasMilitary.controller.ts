...
export class HrBasMilitaryController {
    constructor(private readonly hrBasMilitaryService: HrBasMilitaryService, private readonly databaseService: DatabaseService) { }
    ...
    @GrpcMethod('HrBasMilitaryService', 'HrBasMilitaryA')
    HrBasMilitaryA(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasMilitaryService.HrBasMilitaryA.bind(this.hrBasMilitaryService));
    }
    @GrpcMethod('HrBasMilitaryService', 'HrBasMilitaryU')
    HrBasMilitaryU(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasMilitaryService.HrBasMilitaryU.bind(this.hrBasMilitaryService));
    }
    @GrpcMethod('HrBasMilitaryService', 'HrBasMilitaryD')
    HrBasMilitaryD(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasMilitaryService.HrBasMilitaryD.bind(this.hrBasMilitaryService));
    }
    @GrpcMethod('HrBasMilitaryService', 'HrBasMilitaryQ')
    HrBasMilitaryQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasMilitaryService.HrBasMilitaryQ.bind(this.hrBasMilitaryService));
    }
}