...
export class HrBaslinguisticController {
    constructor(private readonly hrBaslinguisticService: HrBaslinguisticService, private readonly databaseService: DatabaseService) { }
    ...
    @GrpcMethod('HrBaslinguisticService', 'HrBaslinguisticA')
    HrBaslinguisticA(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBaslinguisticService.HrBaslinguisticA.bind(this.hrBaslinguisticService));
    }
    @GrpcMethod('HrBaslinguisticService', 'HrBaslinguisticU')
    HrBaslinguisticU(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBaslinguisticService.HrBaslinguisticU.bind(this.hrBaslinguisticService));
    }
    @GrpcMethod('HrBaslinguisticService', 'HrBaslinguisticD')
    HrBaslinguisticD(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBaslinguisticService.HrBaslinguisticD.bind(this.hrBaslinguisticService));
    }
    @GrpcMethod('HrBaslinguisticService', 'HrBaslinguisticQ')
    HrBaslinguisticQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBaslinguisticService.HrBaslinguisticQ.bind(this.hrBaslinguisticService));
    }
}