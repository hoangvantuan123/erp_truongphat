...
@Controller()
export class HrEmpPlnController {
    constructor(private readonly hrEmpPlnService: HrEmpPlnService, private readonly databaseService: DatabaseService) { }
    ...
    @GrpcMethod('HrEmpPlnService', 'HrEmpPlnA')
    HrEmpPlnA(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrEmpPlnService.HrEmpPlnA.bind(this.hrEmpPlnService));
    }
    @GrpcMethod('HrEmpPlnService', 'HrEmpPlnU')
    HrEmpPlnU(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrEmpPlnService.HrEmpPlnU.bind(this.hrEmpPlnService));
    }
    @GrpcMethod('HrEmpPlnService', 'HrEmpPlnD')
    HrEmpPlnD(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrEmpPlnService.HrEmpPlnD.bind(this.hrEmpPlnService));
    }
    @GrpcMethod('HrEmpPlnService', 'HrEmpPlnQ')
    HrEmpPlnQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrEmpPlnService.HrEmpPlnQ.bind(this.hrEmpPlnService));
    }
}