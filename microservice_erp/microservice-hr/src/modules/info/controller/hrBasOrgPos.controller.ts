...
@Controller()
export class HrBaseOrgPosController {
    constructor(private readonly hrOrgPosService: HrOrgPosService, private readonly databaseService: DatabaseService) { }
    ...
    @GrpcMethod('HrBasOrgPosService', 'HrBasOrgPosA')
    HrBasOrgPosA(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrOrgPosService.HrBasOrgPosA.bind(this.hrOrgPosService));
    }
    @GrpcMethod('HrBasOrgPosService', 'HrBasOrgPosU')
    HrBasOrgPosU(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrOrgPosService.HrBasOrgPosU.bind(this.hrOrgPosService));
    }
    @GrpcMethod('HrBasOrgPosService', 'HrBasOrgPosD')
    HrBasOrgPosD(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrOrgPosService.HrBasOrgPosD.bind(this.hrOrgPosService));
    }
    @GrpcMethod('HrBasOrgPosService', 'HrBasOrgPosQ')
    HrBasOrgPosQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrOrgPosService.HrBasOrgPosQ.bind(this.hrOrgPosService));
    }
}