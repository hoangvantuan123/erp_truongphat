...
@Controller()
export class HBasAcademicController {
    constructor(private readonly hrBasAcademicService: HrBasAcademicService, private readonly databaseService: DatabaseService) { }
    ...
    @GrpcMethod('HrBasAcademicService', 'HrBasAcademicA')
    HrBasAcademicA(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasAcademicService.HrBasAcademicA.bind(this.hrBasAcademicService));
    }
    @GrpcMethod('HrBasAcademicService', 'HrBasAcademicU')
    HrBasAcademicU(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasAcademicService.HrBasAcademicU.bind(this.hrBasAcademicService));
    }
    @GrpcMethod('HrBasAcademicService', 'HrBasAcademicD')
    HrBasAcademicD(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasAcademicService.HrBasAcademicD.bind(this.hrBasAcademicService));
    }
    @GrpcMethod('HrBasAcademicService', 'HrBasAcademicQ')
    HrBasAcademicQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasAcademicService.HrBasAcademicQ.bind(this.hrBasAcademicService));
    }
}