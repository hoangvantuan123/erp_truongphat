...
@Controller()
export class HrBaseTravelController {
    constructor(private readonly hrBaseTravelService: HrBaseTravelService, private readonly databaseService: DatabaseService) { }
    ...
    @GrpcMethod('HrBaseTravelService', 'HrBaseTravelA')
    HrBaseTravelA(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBaseTravelService.HrBaseTravelA.bind(this.hrBaseTravelService));
    }
    @GrpcMethod('HrBaseTravelService', 'HrBaseTravelU')
    HrBaseTravelU(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBaseTravelService.HrBaseTravelU.bind(this.hrBaseTravelService));
    }
    @GrpcMethod('HrBaseTravelService', 'HrBaseTravelD')
    HrBaseTravelD(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBaseTravelService.HrBaseTravelD.bind(this.hrBaseTravelService));
    }
    @GrpcMethod('HrBaseTravelService', 'HrBaseTravelQ')
    HrBaseTravelQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBaseTravelService.HrBaseTravelQ.bind(this.hrBaseTravelService));
    }
}