...
export class HrEmpOneController {
    constructor(private readonly hrEmpOneService: HrEmpOneService, private readonly databaseService: DatabaseService) { }
    ...
    @GrpcMethod('HrEmpOneService', 'HrEmpOneU')
    HrEmpOneU(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrEmpOneService.HrEmpOneU.bind(this.hrEmpOneService));
    }
    @GrpcMethod('HrEmpOneService', 'HrEmpOneQ')
    HrEmpOneQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrEmpOneService.HrEmpOneQ.bind(this.hrEmpOneService));
    }
    @GrpcMethod('HrEmpOneService', 'HrEmpInfoQ')
    HrEmpInfoQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrEmpOneService.HrEmpInfoQ.bind(this.hrEmpOneService));
    }
}