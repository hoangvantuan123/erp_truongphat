...
@Controller()
export class HrBaseUnionController {
    constructor(private readonly hrBasUnionService: HrBasUnionService, private readonly databaseService: DatabaseService) { }
    ...
    @GrpcMethod('HrBasUnionService', 'HrBasUnionA')
    HrBasUnionA(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasUnionService.HrBasUnionA.bind(this.hrBasUnionService));
    }
    @GrpcMethod('HrBasUnionService', 'HrBasUnionU')
    HrBasUnionU(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasUnionService.HrBasUnionU.bind(this.hrBasUnionService));
    }
    @GrpcMethod('HrBasUnionService', 'HrBasUnionD')
    HrBasUnionD(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasUnionService.HrBasUnionD.bind(this.hrBasUnionService));
    }
    @GrpcMethod('HrBasUnionService', 'HrBasUnionQ')
    HrBasUnionQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasUnionService.HrBasUnionQ.bind(this.hrBasUnionService));
    }
}