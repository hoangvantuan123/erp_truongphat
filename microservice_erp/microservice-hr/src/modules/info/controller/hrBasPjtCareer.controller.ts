...
export class HrBasPjtCareerController {
    constructor(private readonly hrBasPjtCareerService: HrBasPjtCareerService, private readonly databaseService: DatabaseService) { }
    ...
    @GrpcMethod('HrBasPjtCareerService', 'HrBasPjtCareerA')
    HrBasPjtCareerA(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasPjtCareerService.HrBasPjtCareerA.bind(this.hrBasPjtCareerService));
    }
    @GrpcMethod('HrBasPjtCareerService', 'HrBasPjtCareerU')
    HrBasPjtCareerU(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasPjtCareerService.HrBasPjtCareerU.bind(this.hrBasPjtCareerService));
    }
    @GrpcMethod('HrBasPjtCareerService', 'HrBasPjtCareerD')
    HrBasPjtCareerD(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasPjtCareerService.HrBasPjtCareerD.bind(this.hrBasPjtCareerService));
    }
    @GrpcMethod('HrBasPjtCareerService', 'HrBasPjtCareerQ')
    HrBasPjtCareerQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrBasPjtCareerService.HrBasPjtCareerQ.bind(this.hrBasPjtCareerService));
    }
}