...
@Injectable()
export class SPRWkAbsEmpService {
    constructor(
    ...
    SPRWkAbsEmpQ(
        ...
        const xmlDocument = this.generateXmlService.generateXMLSPRWkAbsEmpQ(result);

        const query = `
            EXEC VTN_SPRWkAbsEmpQuery_WEB
    ...
    private AutoCheckSPRWkAbsEmp(result: any[], userSeq: number,
        ...
        const xmlDoc1 = this.generateXmlService.generateXMLSPRWkAbsEmpAUD(result, workingTag);
        const query1 = generateQuery(xmlDoc1, '_SPRWkAbsEmpCheck', 2315, 1033334);
        ...
        return forkJoin([
            ...
            switchMap(([data1]) => {
                ...
                const saveXmlDoc1 = this.generateXmlService.generateXMLSPRWkAbsEmpAUD(data1, workingTag);
                const saveQuery1 = generateQuery(saveXmlDoc1, '_SPRWkAbsEmpSave', 2315, 1033334);
    ...
    SPRWkAbsEmpAUD(result: any, companySeq: number, userSeq: number, workingTag: string): Observable<any> {
        return this.AutoCheckSPRWkAbsEmp(result, companySeq, userSeq, result[0].WorkingTag);
    }
