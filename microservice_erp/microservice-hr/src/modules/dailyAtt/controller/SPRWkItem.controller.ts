...
@Controller()
export class SPRWkItemController {
    constructor(private readonly SPRWkItemService: SPRWkItemService,
    ...
    @GrpcMethod('SPRWkItemService', 'SPRWkItemQ')
    SPRWkItemQ(request: any): Observable<MetadataResponse> {

        return this.handleGrpcRequest(request, this.SPRWkItemService.SPRWkItemQ.bind(this.SPRWkItemService));
    }

    @GrpcMethod('SPRWkItemService', 'SPRWkItemAUD')
    SPRWkItemAUD(request: any): Observable<MetadataResponse> {

        return this.handleGrpcRequest(request, this.SPRWkItemService.SPRWkItemAUD.bind(this.SPRWkItemService));
    }
