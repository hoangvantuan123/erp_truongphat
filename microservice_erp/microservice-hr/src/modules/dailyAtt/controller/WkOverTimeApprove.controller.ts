...
@Controller()
export class WkOverTimeApproveController {
    constructor(private readonly WkOverTimeApproveService: WkOverTimeApproveService,
    ...
    @GrpcMethod('WkOverTimeApproveService', 'WkOverTimeApproveQ')
    WkOverTimeApproveQ(request: any): Observable<MetadataResponse> {

        return this.handleGrpcRequest(request, this.WkOverTimeApproveService.WkOverTimeApproveQ.bind(this.WkOverTimeApproveService));
    }

    @GrpcMethod('WkOverTimeApproveService', 'WkOverTimeApproveAUD')
    WkOverTimeApproveAUD(request: any): Observable<MetadataResponse> {

        return this.handleGrpcRequest(request, this.WkOverTimeApproveService.WkOverTimeApproveAUD.bind(this.WkOverTimeApproveService));
    }

    @GrpcMethod('WkOverTimeApproveService', 'WkOverTimeApproveConfirm')
    WkOverTimeApproveConfirm(request: any): Observable<MetadataResponse> {

        return this.handleGrpcRequest(request, this.WkOverTimeApproveService.WkOverTimeApproveConfirm.bind(this.WkOverTimeApproveService));
    }
