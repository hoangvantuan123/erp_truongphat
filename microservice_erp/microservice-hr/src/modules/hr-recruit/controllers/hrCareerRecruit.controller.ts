...
@Controller()
export class HrCareerRecruitController {
    constructor(private readonly erpHrCareerRecruitService: ErpHrCareerRecruitService,
    ...
    @GrpcMethod('HrCareerRecruitService', 'HrCareerRecruitA')
    HrCareerRecruitA(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.erpHrCareerRecruitService.HrCareerRecruitA.bind(this.erpHrCareerRecruitService));
    }
    @GrpcMethod('HrCareerRecruitService', 'HrCareerRecruitU')
    HrCareerRecruitU(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.erpHrCareerRecruitService.HrCareerRecruitU.bind(this.erpHrCareerRecruitService));
    }


    @GrpcMethod('HrCareerRecruitService', 'HrCareerRecruitQ')
    HrCareerRecruitQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.erpHrCareerRecruitService.HrCareerRecruitQ.bind(this.erpHrCareerRecruitService));
    }

    @GrpcMethod('HrCareerRecruitService', 'HrCareerRecruitD')
    HrCareerRecruitD(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.erpHrCareerRecruitService.HrCareerRecruitD.bind(this.erpHrCareerRecruitService));
    }
