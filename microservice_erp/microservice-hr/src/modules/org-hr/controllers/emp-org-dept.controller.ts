...
export class EmpOrgDeptController  {
  constructor(
    private readonly empOrgDeptService: EmpOrgDeptService,
  ...
  @GrpcMethod('EmpOrgDeptService', 'searchTreeEmpOrg')
  searchEmpOrgTree(request: any): Observable<MetadataResponse> {
    return this.handleGrpcRequest(
      request,
      this.empOrgDeptService.searchTreeEmpOrg.bind(this.empOrgDeptService),
    );
  }

  @GrpcMethod('EmpOrgDeptService', 'getEmpByDept')
  getEmpByDept(request: any[]): Observable<MetadataResponse> {
    return this.handleGrpcRequest(
      request,
      this.empOrgDeptService.getEmpByOrgDept.bind(this.empOrgDeptService),
    );
  }
