...
@Controller()
export class ErpEmpSPController {
    constructor(private readonly empSPService: EmpSPService,
    ...
    @GrpcMethod('HelpEmpsService', 'EmpSPH')
    EmpSPH(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.empSPService.EmpSPH.bind(this.empSPService));
    }
    @GrpcMethod('HelpEmpsService', 'EmpSPInterviewH')
    EmpSPInterviewH(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.empSPService.EmpSPInterviewH.bind(this.empSPService));
    }
