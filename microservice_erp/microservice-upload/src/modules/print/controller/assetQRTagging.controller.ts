...
@Controller()
export class ErpJIGQRTaggingController {
    constructor(private readonly erpTemJIGQRService: ErpTemJIGQRService,
    ...
    @GrpcMethod('JIGQRTaggingService', 'JIGQRTaggingPrint')
    JIGQRTaggingPrint(request: any[]): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.erpTemJIGQRService.JIGQRTaggingPrint.bind(this.erpTemJIGQRService));
    }
