...
import { LGEtcTransReqService } from '../services/LGEtcTransReq.service';
import { PrintLGEtcTransController } from '../controller/printLGEtcTrans.controller';
@Module({
    imports: [
        TypeOrmModule.forFeature([ERPPrintFile]),
        TypeOrmModule.forRoot(sqlServerERP)
    ],
    controllers: [ErpJIGQRTaggingController, ErpItemQRTaggingController, FilePrintController, PdmmOutExtraController, PrintController, PrintLGEtcTransController],
    providers: [ErpTemJIGQRService, GenerateXmlService, DocxAssetUtilsService, ERPPrintFileService, GenerateLabelsTemJIGQRService, ErpItemPrintQRService, GenerateLabelsTemItemQRService, PrintPdmmOutExtraService, PrintLgEtcOutService, LGEtcTransReqService],
})
