...
@Controller()
export class HrEmpInfoController {
    constructor(private readonly hrEmpInfoService: HrEmpInfoService, private readonly databaseService: DatabaseService) { }
    ...
    @GrpcMethod('UploadHrEmpInfoService', 'EmpInfoRptQ')
    EmpInfoRptQ(request: any): Observable<MetadataResponse> {
        return this.handleGrpcRequest(request, this.hrEmpInfoService.EmpInfoRptQWrapper.bind(this.hrEmpInfoService));
    }
